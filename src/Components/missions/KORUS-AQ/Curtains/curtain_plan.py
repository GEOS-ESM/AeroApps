...
#    f.contourf(1e9*f.du,r'GEOS-5 Dust Aerosol Concentration [$\mu$g/m$^2$]',
    f.contourf(1e9*f.du,r'GEOS-5 Dust Aerosol Concentration',
               cmap=gacm.jet_l,figFile='du'+figTail, N=32, extend='max')
    f.contourf(1e9*f.bc,r'GEOS-5 Black Carbon Aerosol Concentration',
               cmap=gacm.jet_l,figFile='bc'+figTail,N=32, extend='max')
    f.contourf(1e9*f.oc,r'GEOS-5 Organic Aerosol Concentration',
               cmap=gacm.jet_l,figFile='oc'+figTail,N=32, end='max')
    f.contourf(1e9*f.su,r'GEOS-5 Sulfate Aerosol Concentration',
               cmap=gacm.jet_l,figFile='su'+figTail, N=32, extend='max')
    f.contourf(1e9*f.so2,r'GEOS-5 Sulfer Dioxide Concentration',
