...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print "Usage: "
        print "       curtain_fp flight_plan.ict [fcast_start]"
        print "Example:" 
        print "       curtain_fp WestSeaOnshoreOffshore.20160502.ict latest"
        print "       curtain_fp WestSeaOnshoreOffshore.20160502.ict 20130814_12"
