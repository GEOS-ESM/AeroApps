...
def append_lml(nc, zlib=False):
    ...
    """
    for v in ['o3', 'no', 'no2', 'no3',
        'so2', 'sulf', 'co', 'PM2_5_DRY', 'co_fire', 
        'BC1', 'BC2', 'OC1', 'OC2', 'DUST_1', 'DUST_2', 'DUST_3', 
        'DUST_4', 'DUST_5', 'SEAS_1', 'SEAS_2', 'SEAS_3', 'SEAS_4','rho']:
        var = nc.variables[v]
...
def append_vars(nc, zlib=False): 
    ...
    nz, ny, nx = co.shape
    oc = nc.variables['OC1'][0,:,:,:] + nc.variables['OC2'][0,:,:,:]  # ug kg-1
