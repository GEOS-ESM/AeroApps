...
#........................................................................
    ...
    def __del__ ( self ):
        ...
        try:
            print('=======> GrADS deconstructor started')
            self.p.communicate()
            del self.p
            print('=======> GrADS deconstructor finished')
            #self.cmd('quit')
            print('========> Flushing Popen started')
            self.flush()
            self.Reader.close()
            self.Writer.close()
            print('========> Flushing Popen fininshed')
        except:
            pass
...
#           self.p.communicate()
#           del self.p
            #err_type, err_instance, traceback = sys.exc_info()
            #err_instance.args = (err_instance.args[0] + 'GrADS cannot open file <'+fname+'>',)
            #raise GrADSError('GrADS cannot open file <'+fname+'>'), sys.exc_info()[2]
            #raise err_type, err_instance, traceback
#           raise GrADSError, 'GrADS cannot open file <'+fname+'>', sys.exc_info()[2]
            #raise GrADSError, 'GrADS cannot open file <' + fname + '>', sys.exc_info()[-1]
