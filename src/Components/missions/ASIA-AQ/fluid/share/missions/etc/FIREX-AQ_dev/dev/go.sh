...
for var in $PL; do
  file=z_cams_c_ecmf_%%Y%%m%%d000000_prod_fc_pl_\${tau}_$var.nc
  echo $file
done

for var in $SFC; do
  file=z_cams_c_ecmf_%%Y%%m%%d000000_prod_fc_sfc_\${tau}_$var.nc
  echo $file
done

# for var in $ML; do
#   file=z_cams_c_ecmf_%%Y%%m%%d000000_prod_fc_ml_\${tau}_$var.nc
