...
mkdir -p $LOCAL_TMPDIR/sampling_M2R12K
cp -r /discover/nobackup/pcastell/workspace/GAAS/src/Components/missions/A-CCP/sampling_M2R12K/* $LOCAL_TMPDIR/sampling_M2R12K
ln -s $LOCAL_TMPDIR/sampling_M2R12K ./sampling_M2R12K
