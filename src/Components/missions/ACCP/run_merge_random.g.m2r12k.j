...
######
##################################################################
python -u ./merge_random_mp.py --merged all --exp m2r12k --levelb --surface --ext all --spc all --fine 2013-08-01 2013-09-01 merge_files_m2r12k.pcf gpm.pcf polar07.pcf lidar_ext.m2r12k.pcf
