...
# setup environment
  setenv GEOSMODEL /home/pcolarco/geos_aerosols/pcolarco/Krok/v11.9.0/GEOSgcm/
...
#  set m21cdir = "/home/pcolarco/MERRA21C/e5303_m21c_jan18/chem/Y2022/M09/"
  ...
  foreach file (`\ls -1 $m21cdir/e5303_m21c_jan18.asm_inst_1hr_glo_C360x360x6_v72.2022*T0[0,3,6,9]* $m21cdir/e5303_m21c_jan18.asm_inst_1hr_glo_C360x360x6_v72.2022*T1[2,5,8]* $m21cdir/e5303_m21c_jan18.asm_inst_1hr_glo_C360x360x6_v72.2022*T21*`)
...
#  foreach file (`\ls -1 $m21cdir/e5303_m21c_jan18.aer_inst_3hr_glo_C360x360x6_v72.2022-10-0[1,2,3]*`)
  set file_ = `echo $file:t`
  set ofile = `echo "$file_:gs/C360x360x6/L1152x721/"`
  echo $ofile
