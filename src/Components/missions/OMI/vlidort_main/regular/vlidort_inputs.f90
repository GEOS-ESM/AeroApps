...
!  12/10/21. Version 2.8.5. Rewritten

      VLIDORT_Sup%SLEAVE%TS_LW_BASIC          = ZERO
      VLIDORT_Sup%SLEAVE%TS_KSCALE_ISOTROPIC  = ZERO
      VLIDORT_Sup%SLEAVE%TS_KSCALE_USERANGLES = ZERO
      VLIDORT_Sup%SLEAVE%TS_KSCALE_F_0        = ZERO
      VLIDORT_Sup%SLEAVE%TS_KSCALE_USER_F_0   = ZERO
...
!   -- Several restrictions on use of MSSTS option, need to be checked
      ...
      USE VLIDORT_PARS_m, Only : MAXMOMENTS_INPUT, MAXLAYERS, MAXSTOKES_SQ, MAX_SZANGLES, MAX_USER_RELAZMS, &
                                 ...
                                 MAX_PARTLAYERS, MAX_ALLSTRMS_P1, MAX_TAYLOR_TERMS, MAX_MESSAGES,           &
...
!  Local variables
      ...
      INTEGER ::           I, L, N, UTA, NSTART, NALLSTREAMS, NM, N_PARTLAYERS
      INTEGER ::           INDEX_ANGLES ( MAX_USER_STREAMS )
      DOUBLE PRECISION  :: XT, DT, RT, ALL_ANGLES ( MAX_USER_STREAMS )
      CHARACTER (LEN=3) :: C3
      CHARACTER (LEN=2) :: C2
      LOGICAL ::           LOOP
...
!  10/08/21. Version 2.8.3. Add provision to check N_PARTLAYERS does not exceed dimensioning
