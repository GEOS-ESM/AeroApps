...
def make_plot():
    ...
    ax.set_extent([-85,-40,10.,40],crs=ccrs.PlateCarree())
    ax.coastlines(resolution="50m",zorder=99)
    ax.gridlines(draw_labels=True, dms=True, x_inline=False, y_inline=False, linewidth=1, color='grey')
...
if __name__ == "__main__":
    ...
    plt.savefig("CPEX-AW_tracks.png")
