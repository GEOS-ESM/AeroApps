...
if __name__ == "__main__":
    # Defaults
    bin = 'geo_sampler.py'
    levelBdir = '/discover/nobackup/projects/gmao/osse2/pub/c1440_NR/OBS/GOES-R/DATA/LevelB/'
    scanTimeFile = '/discover/nobackup/projects/gmao/osse2/pub/c1440_NR/OBS/GOES-R/DATA/LevelG/invariant/goes-r.lg1.scantime.nc4'
...
#   --------------------------
    ...
    parser.add_option("--scanTimeFile", dest="scanTimeFile",default=scanTimeFile,
              help="scantime filename" )    
    ...
    bin          = options.bin
    scanTimeFile = options.scanTimeFile
    ...
    outTemplate = '{}/Y{}/M{}/D{}/goes-r-g5nr.lb2.{}.{}_{}z.nc4'
