...
#    template = 'seac4rs-geos5das-PRODUCT_SITE_DATE_RA.1001.ict'
#    top_url='http://opendap.nccs.nasa.gov:9090/dods/GEOS-5/fp/0.25_deg/assim'

    template = 'seac4rs-geos5-SITE-PRODUCT_Model_DATE_R0.1001.ict'
    ...
    fname = daq_dirn + '/seac4rs-UMDAircraft_UMD-AIRCRAFT_20110710_RA_L1.ict' 
