...
"""
    Samples OMI LER data  on a pace trajectory.
...
if __name__ == "__main__":
    ...
    while date <= enddate:
        ...
        outFile = '{}/{}-g5nr.lb.omi_ler.{}_{}.nc4'.format(outpath,instname,nymd,hms)
        ...
        ler = OMI_LER(datadir)
        ler.sample(inFile,outFile,Verbose=args.verbose)
