...
"""
    Samples MYD13C2 (NDVI) on a pace trajectory.
    leo_sampler.py has already been called

    Patricia Castellanos, Oct 2018
...
if __name__ == "__main__":
    ...
    while date <= enddate:
        ...
        outFile = '{}/{}-g5nr.lb.myd13c2.{}_{}.nc4'.format(outpath,instname,nymd,hms)
        inFile  = '{}/{}-g5nr.lb.asm_Nx.{}_{}.nc4'.format(inpath,instname,nymd,hms)

        # Read in trajectory lat/lon
        # Interpolate BRDF 

        ndvi = MYD13C2(datadir,date.year)
        ndvi.sample(inFile,outFile,Verbose=args.verbose)
