...
import test_f_collocate_2   as fc #needed for finding pixels that contain site 
import test_f_find_orbits_2 as fo # needed for finding orbits that contain sites
...
if __name__ == "__main__":
    ...
    user_string = "TEST_new" # additional string to add to output file SiteName_yyyy_<user_string>.txt
    #julian=359 
    ...
    while current_date <= end_date:
        ...
        matching_orbits_list,current_pth =\
                fo.get_orbit_site_matches2(mpl_sites_list,yyyy, mm, dd,verb)
