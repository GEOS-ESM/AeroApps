...
! OUTFILES
  write(OUT_file,'(4A)') trim(outdir),'/',trim(instname),'-g5nr.lc2.vlidort_AI.'
...
!;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  subroutine create_outfile(date, time)
    ...
    integer,dimension(nch)             :: refVarID
...
!                                ----------------------
    ...
    write(comment,'(A)') 'This file contains VLIDORT simulated ' // &
                         'top of the atmosphere ' // &
                         'reflectance from a Rayleigh only atmosphere with black lambertian surface ' // &
