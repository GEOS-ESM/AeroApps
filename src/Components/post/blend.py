...
#   Pass in the MODIS NNR datasets for ocean, land, and deep blue
#   and blend according to the algorithm in the header notes and
#   write to a file located in in {outdir}/ based on filename of
#   input files. Return output file name.
            ...
            for mm in np.arange(1,13):
                ...
                if rc == 0:
                    for ocean in files:
                        ...
                        outfile = blend(ocean,land,deep,outdir=outdir)
