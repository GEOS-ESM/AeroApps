...
# This script runs the FULL VLIDORT/TwoOS package tests which have been set up to
# run using OpenMP (see http://openmp.org for further information about OpenMP)

# Sample command:
# V2OS_full_run_OMP.bash gfortran
# V2OS_full_run_OMP.bash ifort
...
# Run V2OS FULL tests using OpenMP
...
fn_prefix='V2OS_'
fn_suffix='.exe'
for filename in V2OS_*_OMPtester.exe ; do
