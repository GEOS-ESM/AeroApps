...
!  The following SS output may be required for 2OS. Linearized Truncation factor
!    "Rob Change 10/20/14, 10/24/14. Version 2.7E, 2OSCorr implementation"
!      REAL(fpk), dimension ( MAX_ATMOSWFS, MAXLAYERS) :: TS_LC_TRUNCFAC_SS
...
!  The following SS output may be required for 2OS. Linearized Truncation factor
!    "Rob Change 10/20/14, 10/24/14. Version 2.7E, 2OSCorr implementation"
!      REAL(fpk), dimension ( MAX_ATMOSWFS, MAXLAYERS) :: TS_LP_TRUNCFAC_SS
