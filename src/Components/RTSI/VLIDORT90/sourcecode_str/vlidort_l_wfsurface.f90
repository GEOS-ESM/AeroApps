...
! ##########################################################
      ...
      MODULE vlidort_l_wfsurface

      PRIVATE
      PUBLIC :: VLIDORT_SURFACE_WFS
...
!  Finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_SURFACE_WFS
...
!  Finish
      ...
      RETURN
      END SUBROUTINE LS_BVP_COLUMN_SETUP
...
!  Finish
      ...
      RETURN
      END SUBROUTINE GET_LS_BOA_SOURCE
...
!  Finish
      ...
      END MODULE vlidort_l_wfsurface
