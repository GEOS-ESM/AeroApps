...
! #                                                             #
! #            VLIDORT_L_MISCSETUPS (master)                    #
! #              VLIDORT_L_DELTAMSCALE                          #
! #              VLIDORT_L_SSALBINIT                            #
! #              VLIDORT_L_PREPTRANS                            #
! #                                                             #
! ###############################################################
      ...
      MODULE vlidort_l_miscsetups_module

      PRIVATE
      PUBLIC :: VLIDORT_L_MISCSETUPS
      ...
      DOUBLE PRECISION, INTENT (OUT) :: L_AVERAGE_SECANT &
          ( MAXLAYERS, 0:MAXLAYERS, MAXBEAMS, MAX_ATMOSWFS )
      DOUBLE PRECISION, INTENT (OUT) :: L_INITIAL_TRANS &
          ( MAXLAYERS, 0:MAXLAYERS, MAXBEAMS, MAX_ATMOSWFS )
      ...
      DOUBLE PRECISION, INTENT (OUT) :: L_T_DISORDS_UTUP &
          ( MAXSTREAMS, MAX_USER_LEVELS, MAX_ATMOSWFS )
      DOUBLE PRECISION, INTENT (OUT) :: L_T_DELT_MUBAR &
          ( MAXLAYERS, 0:MAXLAYERS, MAXBEAMS, MAX_ATMOSWFS )
      DOUBLE PRECISION, INTENT (OUT) :: L_T_UTDN_MUBAR &
...
!  Transmittance factors variational quantities
...
!  Finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_L_MISCSETUPS
...
!  Finish module
      ...
      RETURN
      END SUBROUTINE VLIDORT_L_DELTAMSCALE
...
!  Finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_L_SSALBINIT
...
!  Help arrays for Green's function removed (see scalar routine)
...
!  Finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_L_PREPTRANS

      END MODULE vlidort_l_miscsetups_module
