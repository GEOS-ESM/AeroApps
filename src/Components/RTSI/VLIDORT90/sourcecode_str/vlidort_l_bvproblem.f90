...
! #                                                             #
! #            L_BVP_SOLUTION_MASTER                            #
! #            L_BVP_BACKSUB                                    #
! #                                                             #
! #            L_BVP_P_COLUMN_SETUP (re-named, Version 2.4)     #
! #            L_BVP_C_COLUMN_SETUP (new for version 2.4)       #
! #            L_BVP_SURFACE_SETUP                              #
! #                                                             #
! #            L_BEAMSOLUTION_P_NEQK (re-named)                 #
! #            L_BEAMSOLUTION_P_NNEK (re-named)                 #
! #            L_BEAMSOLUTION_C_NEQK (new for version 2.4)      #
! #                                                             #
! #  For linearizations with telescoped boundary value problem  #
! #                                                             #
! #            L_BVPTEL_SOLUTION_MASTER                         #
! #            L_BVPTEL_P_COLUMN_SETUP                          #
! #            L_BVPTEL_C_COLUMN_SETUP                          #
! #                                                             #
! ###############################################################


      MODULE vlidort_l_bvproblem

      PRIVATE
      PUBLIC :: L_BVP_SOLUTION_MASTER, &
                L_BVPTEL_SOLUTION_MASTER
      ...
      DOUBLE PRECISION, INTENT (IN) :: L_T_DELT_MUBAR &
          ( MAXLAYERS, 0:MAXLAYERS, MAXBEAMS, MAX_ATMOSWFS )
      DOUBLE PRECISION, INTENT (IN) :: L_BVEC &
...
!  Boundary condition flags for special cases
        ...
        CALL L_BVP_P_COLUMN_SETUP ( &
          ...
          DO_LAYER_SCATTERING, &
          T_DELT_MUBAR, INITIAL_TRANS, BVEC, &
          L_T_DELT_MUBAR, L_BVEC, &
          DO_PLANE_PARALLEL, L_INITIAL_TRANS, &
...
!  Finish
      ...
      RETURN
      END SUBROUTINE L_BVP_SOLUTION_MASTER
...
!  finish
      ...
      RETURN
      END SUBROUTINE L_BVP_P_COLUMN_SETUP
...
!  finish
      ...
      RETURN
      END SUBROUTINE L_BVP_C_COLUMN_SETUP
...
!  Finish
      ...
      RETURN
      END SUBROUTINE L_BEAMSOLUTION_P_NEQK
...
!  Finish
      ...
      RETURN
      END SUBROUTINE L_BEAMSOLUTION_P_NNEK
...
!  Varying index is 0 in the holding arrays
...
!  Finish
      ...
      RETURN
      END SUBROUTINE L_BEAMSOLUTION_C_NEQK
...
!  (error tracing)
        ...
        IF ( INFO .LT. 0 ) THEN
         WRITE(CI, '(I3)' ) INFO
         MESSAGE = 'argument i illegal value, for i = '//CI
         TRACE   = 'DGBTRS call (NLAYERS>1)in L_BVPTEL_SOLUTION_MASTER'
         STATUS  = VLIDORT_SERIOUS
         RETURN
        ENDIF
...
!  Column linearization case is treated separately
!    New code by R. Spurr, 7 December 2008

      IF ( DO_COLUMN_LINEARIZATION ) GO TO 4554

!  Situation 1. Profile linearization
!  **********************************
...
!  Situation 2. Column linearization
!  *********************************

! Continuation point for doing this
...
!  Continuation point for final stuff
...
!  finish
      ...
      RETURN
      END SUBROUTINE L_BVPTEL_SOLUTION_MASTER
...
!  finish
      ...
      RETURN
      END SUBROUTINE L_BVPTEL_P_COLUMN_SETUP
...
!  finish
      ...
      RETURN
      END SUBROUTINE L_BVPTEL_C_COLUMN_SETUP

      END MODULE vlidort_l_bvproblem
