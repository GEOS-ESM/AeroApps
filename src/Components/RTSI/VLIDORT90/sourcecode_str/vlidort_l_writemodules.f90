...
!  Local variables
      ...
      INTEGER :: OUTUNIT
      INTEGER :: SZA,ULEV,LAY,SS,MOM,STRM,S,USTRM,I,IB,URA,STRMI,STRMJ,UVA,WF
...
!  Local variables
      ...
      INTEGER :: OUTUNIT
      INTEGER :: SZA,ULEV,LAY,SS,MOM,STRM,S,USTRM,I,IB,URA,STRMI,STRMJ,UVA,SWF
