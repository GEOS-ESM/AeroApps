...
!  Maximum number of computational layers
      ...
      INTEGER, PARAMETER :: MAXLAYERS = 73
...
!    (Use full range for exact single scatter calculations)
      ...
      INTEGER, PARAMETER :: MAXMOMENTS_INPUT = 301
