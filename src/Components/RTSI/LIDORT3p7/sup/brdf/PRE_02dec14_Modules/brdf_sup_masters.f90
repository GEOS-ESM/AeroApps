...
!  -----------------------------
      ...
      MESSAGES(1:MAX_MESSAGES) = ' '
      NMESSAGES       = 0
      MESSAGES(0)     = 'Successful Execution ofLIDORT BRDF Sup Master'
...
!  Exact Direct Beam BRDF  !@@ Observational Geometry, Optionalities 12/31/12
         ...
         IF ( DO_USER_OBSGEOMS ) THEN
            EXACTDB_BRDFUNC(LUM,LUA,1:NBEAMS) = SCALING * EXACTDB_BRDFUNC(LUM,LUA,1:NBEAMS)
         ELSE
            EXACTDB_BRDFUNC(1:N_USER_STREAMS,1:N_USER_RELAZMS,1:NBEAMS) = &
                 SCALING * EXACTDB_BRDFUNC(1:N_USER_STREAMS,1:N_USER_RELAZMS,1:NBEAMS)
         ENDIF
