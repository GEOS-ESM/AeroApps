...
!  module, dimensions and numbers
      ...
      USE LIDORT_pars, only : fpk, ZERO, ONE, HALF, PIE
...
!  include file of constants
      ...
      USE LIDORT_PARS, only : fpk, ZERO, ONE, HALF, MINUS_ONE, PIE
...
!  module, dimensions and numbers
      ...
      USE LIDORT_pars, only : fpk, MINUS_ONE, HALF
...
SUBROUTINE BRDF_Generalized_Glint &
     ...
     use lidort_pars, only : fpk, zero, one, half, quarter, two, three, four, pie
