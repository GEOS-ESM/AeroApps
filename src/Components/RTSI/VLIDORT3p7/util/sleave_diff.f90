...
!THIS PROGRAM PERFORMS A SPECIALIZED DIFF OF SLEAVE RESULT FILES FOR THE
!FILES SPECIFIED

!PROGRAMMER: MATT CHRISTI
!DATE LAST MODIFIED: 9/3/2014
...
!INTRINSIC SUBPROGRAMS USED BY SLEAVE_DIFF**************************************
!     TRIM,ADJUSTL,LEN
!*******************************************************************************

!EXTERNAL SUBPROGRAMS USED BY SLEAVE_DIFF***************************************
!     GETARG
!*******************************************************************************
...
!STANDARD UNIX DIFF UTILITY AND THEN SEND THE RESULTS TO THE OUTPUT FILE
      ...
      DO I=1,FileSize(1)
        ...
        IF (NumLineDiffs > 0) THEN
          DO J=1,StrLen
!mick fix 9/3/2014 - adjust valid result discriminator
...
!DEALLOCATE SOME ARRAYS
      ...
      IF (TEST) THEN
        WRITE(*,*) 'FINISHED WITH CURRENT CALL TO SLEAVE_DIFF'
        READ(*,*)
      END IF

!END PROGRAM
      !WRITE(*,*)
      !WRITE(*,*) 'SLEAVE_DIFF DONE'
      !WRITE(*,*) '*****************************************************'
      !WRITE(*,*) '*****************************************************'

      END PROGRAM SLEAVE_DIFF
