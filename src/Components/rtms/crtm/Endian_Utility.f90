...
!-------------------------------------------------------------------------------
!
! $Id: Endian_Utility.f90,v 1.6.12.5.2.2 2013/06/26 00:32:48 jguo Exp $
!
! $Date: 2013/06/26 00:32:48 $
!
! $Revision: 1.6.12.5.2.2 $
!
! $State: Exp $
!
! $Name: ams-GEOSadas-5_12_4-x01 $
!
! $Log: Endian_Utility.f90,v $
! Revision 1.6.12.5.2.2  2013/06/26 00:32:48  jguo
! Path: .
! URL: https://svnemc.ncep.noaa.gov/projects/crtm/releases/REL-2.1.3/libsrc
...
! Last Changed Rev: 29405
! Last Changed Date: 2013-06-20 16:19:52 -0400 (Thu, 20 Jun 2013)
!
! ------------------------------------------------------------------------
!
! Revision 1.1  2013/06/25 21:07:26  jguo
