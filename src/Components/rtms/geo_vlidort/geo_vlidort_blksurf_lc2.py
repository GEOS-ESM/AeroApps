                    ...
                    if numpixels>0:
                        ...
                        for runmode in self.runmodeL:
                            ...
                            for i, ch in enumerate(self.channels):
                                ...
                                self.make_rcfile(workdir,startdate,ch,nodemax=nodemax,
                                                   layout=laycode)
...
if __name__ == "__main__":
    ...
    execFile          = '/discover/nobackup/pcastell/workspace/GAAS/src/Components/geo_vlidort/geo_vlidort_blacksurf.x'
