...
C   number of layers will be set from the atmosphere data read
     ...
     &    ('vlidort_v2p4_testing.inp_2',
     &     'vlidort_v2p4_testing.log_2',status_inputread)
      if ( status_inputread.ne.vlidort_success)
     &     stop'BAD READ of file: vlidort_v2p4_testing.inp_2'
