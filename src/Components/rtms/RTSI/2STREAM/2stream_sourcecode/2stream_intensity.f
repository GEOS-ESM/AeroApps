...
C  DB correction commented out, initial streamlined version
...
C  Add direct beam if flagged. DB correction commented out
C        IF ( DO_INCLUDE_DIRECTBEAM .AND. .NOT.DO_DB_CORRECTION ) THEN
