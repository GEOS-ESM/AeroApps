...
C  Single scatter solutions
      ...
      DOUBLE PRECISION INTENSITY_SS_UP(N_GEOMS)
      DOUBLE PRECISION INTENSITY_SS_DN(N_GEOMS)
...
C  Single scatter solutions
      ...
      DOUBLE PRECISION PROFILEWF_SS_UP(N_GEOMS,NLAYERS,NPARS)
      DOUBLE PRECISION PROFILEWF_SS_DN(N_GEOMS,NLAYERS,NPARS)

      DOUBLE PRECISION COLUMNWF_SS_UP(N_GEOMS,NPARS)
      DOUBLE PRECISION COLUMNWF_SS_DN(N_GEOMS,NPARS)

      DOUBLE PRECISION SURFACEWF_DB(N_GEOMS,NSPARS)
...
C  ----------------------------------
     ...
     O     ATMOSWF_F_UP,   PROFILEWF_SS_UP, COLUMNWF_SS_UP,
     O     ATMOSWF_F_DN,   PROFILEWF_SS_DN, COLUMNWF_SS_DN,
...
C  Linearizated contributions
     ...
     I      PROFILEWF_SS_UP, PROFILEWF_SS_DN,
     I      COLUMNWF_SS_UP,  COLUMNWF_SS_DN, SURFACEWF_DB,
     O      PROFILEWF_TOA, PROFILEWF_BOA,
     O      COLUMNWF_TOA,  COLUMNWF_BOA,
     O      SURFACEWF_TOA, SURFACEWF_BOA )
          END DO
...
C  Single scatter solutions. NOT NEEDED
...
C
     ...
     I      SURFACEWF_F_UP,  SURFACEWF_F_DN, 
     I      PROFILEWF_SS_UP, PROFILEWF_SS_DN,
     I      COLUMNWF_SS_UP,  COLUMNWF_SS_DN,
     I      SURFACEWF_DB,
     O      PROFILEWF_TOA, PROFILEWF_BOA,
     O      COLUMNWF_TOA,  COLUMNWF_BOA,
     O      SURFACEWF_TOA, SURFACEWF_BOA )
