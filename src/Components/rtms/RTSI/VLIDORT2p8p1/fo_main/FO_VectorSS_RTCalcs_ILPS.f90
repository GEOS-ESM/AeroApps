...
!  Source function integration results
   ...
   real(ffp)  :: LP_lostrans_up (maxlayers,max_atmoswfs), LP_lostrans_up_p (maxpartials,max_atmoswfs)
...
!  5/5/20. Version 2.8.1 Upgrades. CUMTRANS calculation was not properly initialized (no Jacobians)
...
!  Source function integration results
   ...
   real(ffp)  :: LP_lostrans_dn (maxlayers,max_atmoswfs), LP_lostrans_dn_p (maxpartials,max_atmoswfs)
