...
subroutine SSV_Integral_ILCS_UPDN &
   ( maxgeoms, maxlayers, maxpartials, maxfine, maxmoments_input,                                    & ! Inputs (Dimensioning)
     ...
     Stokes_up, Stokes_db, LC_Jacobians_up, LC_Jacobians_db, LS_Jacobians_db,                        & ! Output (upwelling)
     Stokes_dn, LC_Jacobians_dn, cumtrans, LC_cumtrans )                                               ! Output (cumtrans & dnwell.)
