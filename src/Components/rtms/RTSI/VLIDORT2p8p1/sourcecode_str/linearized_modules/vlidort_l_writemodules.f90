...
!
      ...
      SUBROUTINE VLIDORT_WRITE_LIN_SUP_BRDF_INPUT ( &
        ...
        NSTREAMS,NMOMENTS,N_SURFACE_WFS,&
...
!                   - added NMOMENTS for VLIDORT internal consistency
      ...
      USE VLIDORT_PARS_m, Only : MAX_SURFACEWFS, MAXMOMENTS, MAXSTOKES, MAXSTOKES_SQ, MAXSTREAMS, &
...
!
      ...
      SUBROUTINE VLIDORT_WRITE_LIN_SUP_SLEAVE_INPUT ( &
        DO_USER_STREAMS, &
        NSTOKES,N_SZANGLES,N_USER_VZANGLES,N_USER_RELAZMS,&
        NSTREAMS,NMOMENTS,N_SLEAVE_WFS,&
...
!                   - added NMOMENTS for VLIDORT internal consistency
      ...
      USE VLIDORT_PARS_m, Only : MAXSTOKES, MAX_SLEAVEWFS, MAXMOMENTS, MAX_USER_STREAMS,  &
