...
!  4/9/19. Surface-leaving linearized inputs
      ...
      DOUBLE PRECISION, INTENT (IN) :: LSSL_SLTERM_F_0      ( MAX_SLEAVEWFS, MAXSTOKES, 0:MAXMOMENTS, MAXSTREAMS, MAXBEAMS )
      DOUBLE PRECISION, INTENT (IN) :: LSSL_USER_SLTERM_F_0 ( MAX_SLEAVEWFS, MAXSTOKES, 0:MAXMOMENTS, MAX_USER_STREAMS, MAXBEAMS )
