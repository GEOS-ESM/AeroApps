...
!  Single scattering and DB inputs
      ...
      DOUBLE PRECISION, INTENT (IN) :: PROFILEWF_SS  ( MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, &
                                                       MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS )
      DOUBLE PRECISION, INTENT (IN) :: PROFILEWF_DB  ( MAX_ATMOSWFS, MAXLAYERS, &
...
!  Output fields
      ...
      DOUBLE PRECISION, INTENT (INOUT) :: SURFACEWF ( MAX_SURFACEWFS, MAX_USER_LEVELS, &
                                                      MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS )
      DOUBLE PRECISION, INTENT (INOUT) :: PROFILEWF ( MAX_ATMOSWFS, MAXLAYERS, MAX_USER_LEVELS, &
                                                      MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS )
                    ...
                    DO UT = 1, N_USER_LEVELS
                      DO I = 1, N_OUT_STREAMS
                        DO UA = 1, LOCAL_N_USERAZM
                          ...
                          DO O1 = 1, NSTOKES
                            PROFILEWF(Q,N,UT,V,O1,W) = PROFILEWF_F(Q,N,UT,I,IBEAM,O1,W)
                          ENDDO
                        ENDDO
                      ENDDO
                    ENDDO
              ...
              IF ( LAYER_VARY_FLAG(N) ) THEN
                DO Q = 1, LAYER_VARY_NUMBER(N)
                  DO IDIR = 1, N_DIRECTIONS
                    ...
                    DO UT = 1, N_USER_LEVELS
                      DO O1 = 1, NSTOKES
                        PROFILEWF(Q,N,UT,IB,O1,W) = PROFILEWF_F(Q,N,UT,LUM,IB,O1,W)
                      ENDDO
                    ENDDO
                  ENDDO
                ENDDO
                  ...
                  DO IDIR = 1, N_DIRECTIONS
                    ...
                    DO UT = 1, N_USER_LEVELS
                      DO O1 = 1, NSTOKES
                        ...
                        PROFILEWF(Q,N,UT,IB,O1,W) = PROFILEWF(Q,N,UT,IB,O1,W) + PROFILEWF_SS(Q,N,UT,IB,O1,W)
                      ENDDO
                    ENDDO
                  ENDDO
                ENDDO
                ...
                DO Q = 1, LAYER_VARY_NUMBER(N)
                  DO UT = 1, N_USER_LEVELS
                     DO O1 = 1, NSTOKES
                       ...
                       PROFILEWF(Q,N,UT,IB,O1,UPIDX) = PROFILEWF(Q,N,UT,IB,O1,UPIDX) + PROFILEWF_DB(Q,N,UT,IB,O1)
                     ENDDO
                  ENDDO
                ENDDO
              ENDIF
