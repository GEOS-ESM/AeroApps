...
! ##########################################################
      ...
      MODULE vlidort_lc_wfatmos_m

      PRIVATE :: GET_LC_TOASOURCE,        GET_LC_BOASOURCE,       & 
                 LC_WHOLELAYER_STERM_UP,  LC_WHOLELAYER_STERM_DN, &
      ...
      SUBROUTINE UPUSER_COLUMNWF ( &
        ...
        N_USER_STREAMS, N_USER_LEVELS, NV_PARAMETERS, LOCAL_UM_START,      & ! Input numbers (basic)
...
!  Linearized transmittance flux for water-leaving
      ...
      DOUBLE PRECISION, INTENT (IN) ::  LC_TRANS_ATMOS_FINAL (MAXBEAMS,MAX_ATMOSWFS)
...
!  Linearized output (Ostensibly output)
      ...
      DOUBLE PRECISION, INTENT (INOUT) :: COLUMNWF_F ( MAX_ATMOSWFS, MAX_USER_LEVELS, &
...
!  help
      ...
      LOGICAL ::          SFLAG
      INTEGER ::          M, N, NUT, NVPARS, NSTART, NUT_PREV, NLEVEL, O1
      INTEGER ::          UTA, UM, Q, NC, UT, IB, LUM
          ...
          DO Q = 1, NV_PARAMETERS
            IF (.not. DO_OBSERVATION_GEOMETRY ) THEN
              DO UM = 1, N_USER_STREAMS
                DO O1 = 1, NSTOKES
                  COLUMNWF_F(Q,UTA,UM,IB,O1,UPIDX) = ZERO
                ENDDO
              ENDDO
            ELSE
              DO O1 = 1, NSTOKES
                COLUMNWF_F(Q,UTA,LUM,IB,O1,UPIDX) = ZERO
              ENDDO
            ENDIF
          ENDDO
        ENDDO
...
!  Get the linearized BOA source terms (diffuse and direct)
        ...
        CALL GET_LC_BOASOURCE ( &
          ...
          DO_INCLUDE_DIRECTRF, DO_INCLUDE_DIRECTSL, NV_PARAMETERS, FOURIER,  & ! Input flags, linearization control
...
!if ( fourier.eq.0.and.ib.eq.1.and.um.eq.1)&
!write(*,*)'Columnwfs',FOURIER,IBEAM,UM,Q,O1,L_BOA_MSSOURCE(UM,O1,Q), L_BOA_DBSOURCE(UM,O1,Q)
              ENDDO
            ENDDO
          ENDDO
        ELSE
        ...
        IF ( DO_USER_STREAMS ) THEN
          ...
          DO N = NSTART, NUT, -1
            ...
            CALL LC_WHOLELAYER_STERM_UP ( &
              ...
              N, M, IB, NVPARS, NSTOKES, N_USER_STREAMS, LOCAL_UM_START,       & ! Input numbers
              ...
              NCON, PCON, L_UHOM_UPDN, L_UHOM_UPUP, L_UPAR_UP_1, LC_UPAR_UP_2, & ! Input linearized solutions
              L_HMULT_1, L_HMULT_2, LC_EMULT_UP, L_LAYER_TSUP_UP,              & ! Input linearized multiplieres
...
!  User-defined stream output, add additional partial layer source term
          ...
          IF ( DO_USER_STREAMS ) THEN
            CALL LC_PARTLAYER_STERM_UP ( &
              DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,   & ! Input flags
              DO_OBSERVATION_GEOMETRY, DO_MSMODE_VLIDORT, SFLAG,               & ! Input flags
              N, UT, IB, NVPARS, NSTOKES, N_USER_STREAMS, LOCAL_UM_START,      & ! Input numbers
              ...
              NCON, PCON, L_UHOM_UPDN, L_UHOM_UPUP, L_UPAR_UP_1, LC_UPAR_UP_2, & ! Linearized solutions
              L_UT_HMULT_UU, L_UT_HMULT_UD, LC_UT_EMULT_UP, L_LAYER_TSUP_UTUP, & ! Linearized multipliers and thermal
              ...
              DO UM = LOCAL_UM_START, N_USER_STREAMS
                DO O1 = 1, NSTOKES
                  DO Q = 1, NV_PARAMETERS
                    ...
                    COLUMNWF_F(Q,UTA,UM,IB,O1,UPIDX) = FLUX_MULTIPLIER * L_FINAL_SOURCE
                  ENDDO
                ENDDO
              ENDDO
            ELSE
              DO O1 = 1, NSTOKES
                DO Q = 1, NV_PARAMETERS
                  ...
                  COLUMNWF_F(Q,UTA,LUM,IB,O1,UPIDX) = FLUX_MULTIPLIER * L_FINAL_SOURCE
                ENDDO
              ENDDO
            ENDIF
...
!                    if (DABS(L_FINAL_SOURCE).GT.1.0d-12 ) then
                      COLUMNWF_F(Q,UTA,UM,IB,O1,UPIDX) = L_FINAL_SOURCE
!                    endif
                  ENDDO
                ENDDO
              ENDDO
...
!                  if (DABS(L_FINAL_SOURCE).GT.1.0d-12 ) then
                    COLUMNWF_F(Q,UTA,LUM,IB,O1,UPIDX) = L_FINAL_SOURCE
!                  endif
                ENDDO
              ENDDO
            ENDIF
...
!
      ...
      SUBROUTINE DNUSER_COLUMNWF ( &
        ...
        DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS,   DO_THERMAL_TRANSONLY,           & ! Input flags (sources)
        DO_LAYER_SCATTERING, FOURIER, IBEAM, NV_PARAMETERS, NSTOKES,               & ! Input numbers (basic)
...
!  Linearized output (Ostensibly output)
      ...
      DOUBLE PRECISION, INTENT (INOUT) :: COLUMNWF_F ( MAX_ATMOSWFS, MAX_USER_LEVELS, MAX_USER_VZANGLES, &
...
!  help
      ...
      LOGICAL ::          SFLAG
      INTEGER ::          N, NUT, NVPARS, NSTART, NUT_PREV, NLEVEL, O1
...
!mick fix 1/9/2013 - changed limit of do loop
              ...
              DO UM = 1, N_USER_STREAMS
                DO O1 = 1, NSTOKES
                  COLUMNWF_F(Q,UTA,UM,IB,O1,DNIDX) = ZERO
                ENDDO
              ENDDO
            ELSE
              DO O1 = 1, NSTOKES
                COLUMNWF_F(Q,UTA,LUM,IB,O1,DNIDX) = ZERO
              ENDDO
            ENDIF
          ENDDO
        ENDDO
        ...
        IF ( DO_USER_STREAMS ) THEN
          ...
          DO N = NSTART, NUT
            ...
            CALL LC_WHOLELAYER_STERM_DN ( &
              ...
              NCON, PCON, L_UHOM_DNDN, L_UHOM_DNUP, L_UPAR_DN_1, LC_UPAR_DN_2, & ! Input linearized solutions
              L_HMULT_1, L_HMULT_2, LC_EMULT_DN, L_LAYER_TSUP_DN,              & ! Input linearized multiplieres
              L_LAYER_SOURCE )                                                   ! OUTPUT
...
!  User-defined stream output, add additional partial layer source term
          ...
          IF ( DO_USER_STREAMS ) THEN
            CALL LC_PARTLAYER_STERM_DN ( &
              ...
              NCON, PCON, L_UHOM_DNDN, L_UHOM_DNUP, L_UPAR_DN_1, LC_UPAR_DN_2, & ! Input linearized solutions
              L_UT_HMULT_DU, L_UT_HMULT_DD, LC_UT_EMULT_DN, L_LAYER_TSUP_UTDN, & ! Input linearized Multipliers
              L_LAYER_SOURCE )                                                   ! OUTPUT
              ...
              DO UM = LOCAL_UM_START, N_USER_STREAMS
                DO O1 = 1, NSTOKES
                  DO Q = 1, NV_PARAMETERS
                    ...
                    COLUMNWF_F(Q,UTA,UM,IB,O1,DNIDX) = FLUX_MULTIPLIER * L_FINAL_SOURCE
                  ENDDO
                ENDDO
              ENDDO
            ELSE
              DO O1 = 1, NSTOKES
                DO Q = 1, NV_PARAMETERS
                  ...
                  COLUMNWF_F(Q,UTA,LUM,IB,O1,DNIDX) = FLUX_MULTIPLIER * L_FINAL_SOURCE
                ENDDO
              ENDDO
            ENDIF
          ...
          IF ( DO_USER_STREAMS ) THEN
            IF (.not. DO_OBSERVATION_GEOMETRY ) THEN
              DO UM = LOCAL_UM_START, N_USER_STREAMS
                DO O1 = 1, NSTOKES
                  DO Q = 1, NV_PARAMETERS
                    COLUMNWF_F(Q,UTA,UM,IB,O1,DNIDX) = FLUX_MULTIPLIER * L_CUMUL_SOURCE(UM,O1,Q)
                  ENDDO
                ENDDO
              ENDDO
            ELSE
              DO O1 = 1, NSTOKES
                DO Q = 1, NV_PARAMETERS
                  COLUMNWF_F(Q,UTA,LUM,IB,O1,DNIDX) = FLUX_MULTIPLIER * L_CUMUL_SOURCE(IB,O1,Q)
                ENDDO
              ENDDO
            ENDIF
          ENDIF
...
!
      ...
      SUBROUTINE GET_LC_BOASOURCE ( &
          ...
          DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,     & ! Input flags
          DO_INCLUDE_SURFACE, DO_LAMBERTIAN_SURFACE, DO_DBCORRECTION,        & ! Input flags
          DO_INCLUDE_DIRECTRF, DO_INCLUDE_DIRECTSL, NV_PARAMETERS, FOURIER,  & ! Input flag, linearization control
          IBEAM, NSTOKES, NSTREAMS, NLAYERS, N_USER_STREAMS, LOCAL_UM_START, & ! Input Numbers
          DELTAU_SLANT, QUAD_WEIGHTS, QUAD_STRMWTS, MUELLER_INDEX,           & ! Input bookkeeping
          SURFACE_FACTOR, ALBEDO, BRDF_F, USER_BRDF_F,                       & ! Input Surface
          RF_USER_DIRECT_BEAM, SL_USERTERM, LC_TRANS_ATMOS_FINAL,            & ! Input surface radiance
          K_REAL, K_COMPLEX, SOLA_XPOS, SOLB_XNEG, T_DELT_EIGEN,             & ! Input Homog solutions
          LCON, MCON, T_DELT_DISORDS, T_WLOWER,                              & ! Input Thermal and PI
          L_DELTAU_VERT, L_T_DELT_DISORDS, L_T_WLOWER,                       & ! Linearized thermal and misc.
...
!  Add direct beam if flagged
      ...
      IF ( DO_INCLUDE_DIRECTRF.AND..NOT.DO_DBCORRECTION .AND.DO_USER_STREAMS) THEN
         IF (.not. DO_OBSERVATION_GEOMETRY ) THEN
            DO UM = LOCAL_UM_START, N_USER_STREAMS
               DO O1 = 1, NELEMENTS
                  FAC = - RF_USER_DIRECT_BEAM(UM,IB,O1)
                  DO Q = 1, NV_PARAMETERS
                     L_BEAM = DOT_PRODUCT(L_DELTAU_VERT(Q,1:N),DELTAU_SLANT(N,1:N,IB))
                     L_BOA_DBSOURCE(UM,O1,Q) = L_BOA_DBSOURCE(UM,O1,Q) + L_BEAM * FAC
                  ENDDO
               ENDDO
            ENDDO
         ELSE
            DO O1 = 1, NELEMENTS
               FAC = - RF_USER_DIRECT_BEAM(LUM,IB,O1)
               DO Q = 1, NV_PARAMETERS
                  L_BEAM = DOT_PRODUCT(L_DELTAU_VERT(Q,1:N),DELTAU_SLANT(N,1:N,IB))
                  L_BOA_DBSOURCE(IB,O1,Q) = L_BOA_DBSOURCE(IB,O1,Q) + L_BEAM * FAC
               ENDDO
            ENDDO
         ENDIF
      ENDIF
      ...
      IF ( DO_INCLUDE_DIRECTSL .AND. DO_USER_STREAMS ) THEN
         ...
         IF (.not. DO_OBSERVATION_GEOMETRY ) THEN
            DO UM = LOCAL_UM_START, N_USER_STREAMS
               ...
               DO Q = 1, NV_PARAMETERS
                  L_BOA_DBSOURCE(UM,O1,Q) = L_BOA_DBSOURCE(UM,O1,Q) +  LC_TRANS_ATMOS_FINAL(IB,Q) * FAC
               ENDDO
            ENDDO
         ELSE
            FAC = SL_USERTERM(LUM,IB,O1)
            DO Q = 1, NV_PARAMETERS
               L_BOA_DBSOURCE(IB,O1,Q) = L_BOA_DBSOURCE(IB,O1,Q) +  LC_TRANS_ATMOS_FINAL(IB,Q) * FAC
            ENDDO
         ENDIF
      ENDIF
                ...
                DO O1 = 1, NSTOKES
                  ...
                  DO J = 1, NSTREAMS
                    ...
                    DO O2 = 1, NSTOKES
                      ...
                      S_REFLEC = S_REFLEC + L_DOWN(J,O2,Q) * USER_BRDF_F(M,OM,UM,J)
                    ENDDO
            ...
            ELSE
              DO O1 = 1, NSTOKES
                ...
                DO J = 1, NSTREAMS
                  ...
                  DO O2 = 1, NSTOKES
                    OM = MUELLER_INDEX(O1,O2)
                    S_REFLEC = S_REFLEC + L_DOWN(J,O2,Q) * USER_BRDF_F(M,OM,IB,J)
                  ENDDO
                  REFLEC = REFLEC + S_REFLEC
                ENDDO
                REFLEC = KMULT * REFLEC
...
!
      ...
      SUBROUTINE LC_WHOLELAYER_STERM_UP ( &
          ...
          GIVEN_LAYER, FOURIER, IBEAM, NV_PARAMETERS,                      & ! Input numbers
...
!  add particular solution
        ...
        DO UM = LOCAL_UM_START, N_USER_STREAMS
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SPAR = LC_UPAR_UP_2(UM,O1,N,Q) *   EMULT_UP(UM,N,IB) + &
                        UPAR_UP_2(UM,O1,N)    * LC_EMULT_UP(UM,N,IB,Q)
            ...
            DO O1 = 1, NSTOKES
              DO Q = 1, NV_PARAMETERS
                SPAR = L_UPAR_UP_1(UM,O1,N,Q) *   EMULT_UP(UM,N,IB) + &
                         UPAR_UP_1(UM,O1,N)   * LC_EMULT_UP(UM,N,IB,Q)
                L_LAYERSOURCE(UM,O1,Q) = L_LAYERSOURCE(UM,O1,Q) + SPAR
              ENDDO
            ENDDO
          ENDDO
...
!  add particular solution
        ...
        DO O1 = 1, NSTOKES
          DO Q = 1, NV_PARAMETERS
            SPAR = LC_UPAR_UP_2(IB,O1,N,Q) *   EMULT_UP(LUM,N,IB) + &
                      UPAR_UP_2(IB,O1,N)    * LC_EMULT_UP(LUM,N,IB,Q)
          ...
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SPAR = L_UPAR_UP_1(IB,O1,N,Q) *   EMULT_UP(LUM,N,IB) + &
                       UPAR_UP_1(IB,O1,N)   * LC_EMULT_UP(LUM,N,IB,Q)
              L_LAYERSOURCE(IB,O1,Q) = L_LAYERSOURCE(IB,O1,Q) + SPAR
            ENDDO
          ENDDO
        ENDIF
...
!  add particular solution
        ...
        DO UM = LOCAL_UM_START, N_USER_STREAMS
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SPAR = LC_UPAR_DN_2(UM,O1,N,Q) *   EMULT_DN(UM,N,IB) + &
                        UPAR_DN_2(UM,O1,N)    * LC_EMULT_DN(UM,N,IB,Q)
              L_LAYERSOURCE(UM,O1,Q) = L_LAYERSOURCE(UM,O1,Q) + SPAR
            ENDDO
          ENDDO
        ENDDO
            ...
            DO O1 = 1, NSTOKES
              DO Q = 1, NV_PARAMETERS
                SPAR = L_UPAR_DN_1(UM,O1,N,Q) *   EMULT_DN(UM,N,IB) + &
                         UPAR_DN_1(UM,O1,N)   * LC_EMULT_DN(UM,N,IB,Q)
                L_LAYERSOURCE(UM,O1,Q) = L_LAYERSOURCE(UM,O1,Q) + SPAR
              ENDDO
            ENDDO
          ENDDO
...
!  add particular solution
        ...
        DO O1 = 1, NSTOKES
          DO Q = 1, NV_PARAMETERS
            SPAR = LC_UPAR_DN_2(IB,O1,N,Q) *   EMULT_DN(LUM,N,IB) + &
                      UPAR_DN_2(IB,O1,N)    * LC_EMULT_DN(LUM,N,IB,Q)
            L_LAYERSOURCE(IB,O1,Q) = L_LAYERSOURCE(IB,O1,Q) + SPAR
          ENDDO
        ENDDO
          ...
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SPAR = L_UPAR_DN_1(IB,O1,N,Q) *   EMULT_DN(LUM,N,IB) + &
                       UPAR_DN_1(IB,O1,N)   * LC_EMULT_DN(LUM,N,IB,Q)
              L_LAYERSOURCE(IB,O1,Q) = L_LAYERSOURCE(IB,O1,Q) + SPAR
            ENDDO
          ENDDO
        ENDIF
...
!
      ...
      SUBROUTINE LC_PARTLAYER_STERM_UP ( &
           DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,   & ! Input flags
           DO_OBSERVATION_GEOMETRY, DO_MSMODE_VLIDORT, SOURCETERM_FLAG,     & ! Input flags
           GIVEN_LAYER, OFFGRID_INDEX, IBEAM, NV_PARAMETERS,                & ! Input numbers
           NSTOKES, N_USER_STREAMS, LOCAL_UM_START,                         & ! Input numbers
           K_REAL, K_COMPLEX, LCON, MCON, UHOM_UPDN, UHOM_UPUP, UPAR_UP_1,  & ! Input user-solutions
           UPAR_UP_2, UT_HMULT_UU, UT_HMULT_UD, UT_EMULT_UP,                & ! Input multipliers
           NCON, PCON, L_UHOM_UPDN, L_UHOM_UPUP, L_UPAR_UP_1, LC_UPAR_UP_2, & ! Input linearized solutions
...
!  add particular solution
        ...
        DO UM = LOCAL_UM_START, N_USER_STREAMS
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SP = LC_UPAR_UP_2(UM,O1,N,Q) *   UT_EMULT_UP(UM,UT,IB) + &
                      UPAR_UP_2(UM,O1,N)    * LC_UT_EMULT_UP(UM,UT,IB,Q)
            ...
            DO O1 = 1, NSTOKES
              DO Q = 1, NV_PARAMETERS
                SP = L_UPAR_UP_1(UM,O1,N,Q) *   UT_EMULT_UP(UM,UT,IB) + &
                       UPAR_UP_1(UM,O1,N)   * LC_UT_EMULT_UP(UM,UT,IB,Q)
                L_LAYERSOURCE(UM,O1,Q) = L_LAYERSOURCE(UM,O1,Q) + SP
              ENDDO
            ENDDO
          ENDDO
...
!  add particular solution
        ...
        DO O1 = 1, NSTOKES
          DO Q = 1, NV_PARAMETERS
            SP = LC_UPAR_UP_2(IB,O1,N,Q) *   UT_EMULT_UP(LUM,UT,IB) + &
                    UPAR_UP_2(IB,O1,N)    * LC_UT_EMULT_UP(LUM,UT,IB,Q)
          ...
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SP = L_UPAR_UP_1(IB,O1,N,Q) *   UT_EMULT_UP(LUM,UT,IB) + &
                     UPAR_UP_1(IB,O1,N)   * LC_UT_EMULT_UP(LUM,UT,IB,Q)
              L_LAYERSOURCE(IB,O1,Q) = L_LAYERSOURCE(IB,O1,Q) + SP
            ENDDO
          ENDDO
        ENDIF
...
!  add particular solution
        ...
        DO UM = LOCAL_UM_START, N_USER_STREAMS
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SP = LC_UPAR_DN_2(UM,O1,N,Q) *   UT_EMULT_DN(UM,UT,IB) + &
                      UPAR_DN_2(UM,O1,N)    * LC_UT_EMULT_DN(UM,UT,IB,Q)
              L_LAYERSOURCE(UM,O1,Q) = L_LAYERSOURCE(UM,O1,Q) + SP
            ENDDO
          ENDDO
        ENDDO
            ...
            DO O1 = 1, NSTOKES
              DO Q = 1, NV_PARAMETERS
                SP = L_UPAR_DN_1(UM,O1,N,Q) *   UT_EMULT_DN(UM,UT,IB) + &
                       UPAR_DN_1(UM,O1,N)   * LC_UT_EMULT_DN(UM,UT,IB,Q)
                L_LAYERSOURCE(UM,O1,Q) = L_LAYERSOURCE(UM,O1,Q) + SP
              ENDDO
            ENDDO
          ENDDO
...
!  add particular solution
        ...
        DO O1 = 1, NSTOKES
          DO Q = 1, NV_PARAMETERS
            SP = LC_UPAR_DN_2(IB,O1,N,Q) *   UT_EMULT_DN(LUM,UT,IB) + &
                    UPAR_DN_2(IB,O1,N)    * LC_UT_EMULT_DN(LUM,UT,IB,Q)
            L_LAYERSOURCE(IB,O1,Q) = L_LAYERSOURCE(IB,O1,Q) + SP
          ENDDO
        ENDDO
          ...
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
              SP = L_UPAR_DN_1(IB,O1,N,Q) *   UT_EMULT_DN(LUM,UT,IB) + &
                     UPAR_DN_1(IB,O1,N)   * LC_UT_EMULT_DN(LUM,UT,IB,Q)
              L_LAYERSOURCE(IB,O1,Q) = L_LAYERSOURCE(IB,O1,Q) + SP
            ENDDO
          ENDDO
        ENDIF
...
!
      ...
      SUBROUTINE MIFLUX_COLUMNWF ( &
        ...
        DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY, & ! Input flags
        IBEAM, NV_PARAMETERS, NSTOKES, NSTREAMS, NLAYERS,              & ! Input numbers
...
!mick fix 9/19/2017 - added LC_LEVELS_SOLARTRANS & LC_PARTIALS_SOLARTRANS to facilitate correction
...
!  Input basic numbers
      ...
      INTEGER, INTENT (IN) ::          IBEAM, NV_PARAMETERS
      INTEGER, INTENT (IN) ::          NSTOKES
      INTEGER, INTENT (IN) ::          NSTREAMS
      INTEGER, INTENT (IN) ::          NLAYERS
...
!  Help variables
      ...
      DOUBLE PRECISION :: L_TRANS, L_FTRANS, L_DNDIRECT_MEANST, L_DNDIRECT_FLUX
          ...
          DO UTA = 1, N_USER_LEVELS
            ...
            IF ( PARTLAYERS_OUTFLAG(UTA) ) THEN
              ...
              CALL QUADCOLUMNWF_OFFGRID_UP ( &
                DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,       & ! Input flags
                N, UTA, UT, IBEAM,  NV_PARAMETERS, NSTOKES, NSTREAMS, NLAYERS,       & ! Input numbers
                ...
                L_T_DELT_DISORDS, L_T_DISORDS_UTUP, LC_T_UTDN_MUBAR,                 & ! Linearized
            ...
            ELSE
              CALL QUADCOLUMNWF_LEVEL_UP ( &
                DO_THERMAL_TRANSONLY, NLEVEL, UTA, NV_PARAMETERS, NSTOKES,         & ! Input flag/numbers
          ...
          DO UTA = 1, N_USER_LEVELS
            ...
            IF ( PARTLAYERS_OUTFLAG(UTA) ) THEN
              ...
              CALL QUADCOLUMNWF_OFFGRID_DN ( &
                DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,       & ! Input flags
                N, UTA, UT, IBEAM, NV_PARAMETERS, NSTOKES, NSTREAMS,                 & ! Input numbers
                ...
                L_T_DELT_DISORDS, L_T_DISORDS_UTDN, LC_T_UTDN_MUBAR,                 & ! Linearized
                L_SOLA_XPOS, L_SOLB_XNEG, L_T_UTUP_EIGEN, L_T_UTDN_EIGEN, L_WUPPER,  & ! Linearized Homog. solutions
          ...
          DO Q = 1, NV_PARAMETERS
            DO UTA = 1, N_USER_LEVELS
              DO O1 = 1, NSTOKES
                ...
                ENDDO
                MEANST_DIFFUSE_COLWF(Q,UTA,IBEAM,O1,WDIR) = SMI * HALF
                FLUX_DIFFUSE_COLWF(Q,UTA,IBEAM,O1,WDIR)   = SFX * PI2
              ENDDO
            ENDDO
          ENDDO
...
!                    DO Q = 1, NV_PARAMETERS
!                      L_TRANS = LC_T_UTDN_MUBAR(UT,IBEAM,Q) + &
!                               LC_INITIAL_TRANS(N,IBEAM,Q) * T_UTDN_MUBAR(UT,IBEAM)
...
!                        MINT_COLUMNWF_DIRECT(Q,UTA,IBEAM,O1)=L_DIRECT_MEANI
!                        FLUX_COLUMNWF_DIRECT(Q,UTA,IBEAM,O1)=L_DIRECT_FLUX
!                        MINT_COLUMNWF(Q,UTA,IBEAM,O1,WDIR) = &
!                                   MINT_COLUMNWF(Q,UTA,IBEAM,O1,WDIR) + L_DIRECT_MEANI
!                        FLUX_COLUMNWF(Q,UTA,IBEAM,O1,WDIR) = &
!                                  FLUX_COLUMNWF(Q,UTA,IBEAM,O1,WDIR) + L_DIRECT_FLUX
!                      ENDDO
!                    ENDDO
!                  ENDIF
...
!  Linearized direct transmittances, scaled and unscaled
                      ...
                      L_TRANS = LC_PARTIALS_SOLARTRANS(UT,IBEAM,Q)
                      HELP    = LC_T_UTDN_MUBAR(UT,IBEAM,Q) + &
                                LC_INITIAL_TRANS(N,IBEAM,Q) * T_UTDN_MUBAR(UT,IBEAM)
...
!  Direct calculation with non-scaled linearized transmittances
                        ...
                        DNMEANST_DIRECT_COLWF(Q,UTA,IBEAM,O1) = L_DNDIRECT_MEANST
                        DNFLUX_DIRECT_COLWF(Q,UTA,IBEAM,O1)   = L_DNDIRECT_FLUX
...
!  Diffuse calculation
                        ...
                        MEANST_DIFFUSE_COLWF(Q,UTA,IBEAM,O1,WDIR) = &
                              MEANST_DIFFUSE_COLWF(Q,UTA,IBEAM,O1,WDIR) + ( L_DNDIRECT_MEANST_SCALED - L_DNDIRECT_MEANST )
                        FLUX_DIFFUSE_COLWF(Q,UTA,IBEAM,O1,WDIR) = &
                              FLUX_DIFFUSE_COLWF(Q,UTA,IBEAM,O1,WDIR)   + ( L_DNDIRECT_FLUX_SCALED - L_DNDIRECT_FLUX )
                      ENDDO
                    ENDDO
                  ENDIF
...
!                    IF ( N.GT.0 ) THEN
!                      DO Q = 1, NV_PARAMETERS
!                        L_TRANS = LC_T_DELT_MUBAR(N,IBEAM,Q) + &
!                                     LC_INITIAL_TRANS(N,IBEAM,Q) * T_DELT_MUBAR(N,IBEAM)
!                        L_TRANS = L_TRANS * INITIAL_TRANS(N,IBEAM)
!                        DO O1 = 1, NSTOKES
!
!!  @@@ Rob fix (Forgot the Flux factor)
...
!  Linearized direct transmittances, scaled and unscaled
                        ...
                        L_TRANS = LC_LEVELS_SOLARTRANS(N,IBEAM,Q)
                        HELP    = LC_T_DELT_MUBAR(N,IBEAM,Q) + &
                                  LC_INITIAL_TRANS(N,IBEAM,Q) * T_DELT_MUBAR(N,IBEAM)
                        L_TRANS_SCALED = HELP * INITIAL_TRANS(N,IBEAM)
...
!
      ...
      SUBROUTINE QUADCOLUMNWF_OFFGRID_UP ( &
           DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,       & ! Input flags
           N, UTA, UT, IB, NV_PARAMETERS, NSTOKES, NSTREAMS, NLAYERS,           & ! Input numbers
           FLUX_MULTIPLIER, QUAD_STREAMS, T_DELT_DISORDS, T_DISORDS_UTUP,       & ! flux/quad/D.O.trans
           K_REAL, K_COMPLEX, SOLA_XPOS, SOLB_XNEG, T_UTUP_EIGEN, T_UTDN_EIGEN, & ! Input Homog. solutions
           T_UTDN_MUBAR, WUPPER, LCON, MCON, T_WUPPER, BOA_THTONLY_SOURCE,      & ! Input thermal and PI solutions
           L_T_DELT_DISORDS, L_T_DISORDS_UTUP, LC_T_UTDN_MUBAR,                 & ! Linearized
...
!
      ...
      SUBROUTINE QUADCOLUMNWF_OFFGRID_DN ( &
           DO_SOLAR_SOURCES, DO_INCLUDE_THERMEMISS, DO_THERMAL_TRANSONLY,       & ! Input flags
           N, UTA, UT, IB, NV_PARAMETERS, NSTOKES, NSTREAMS,                    & ! Input numbers
           FLUX_MULTIPLIER, QUAD_STREAMS, T_DELT_DISORDS, T_DISORDS_UTDN,       & ! flux/quad/D.O.trans
           K_REAL, K_COMPLEX, SOLA_XPOS, SOLB_XNEG, T_UTUP_EIGEN, T_UTDN_EIGEN, & ! Input Homog. solutions
           T_UTDN_MUBAR, WUPPER, LCON, MCON, T_WUPPER, T_WLOWER,                & ! Input thermal and PI solutions
           L_T_DELT_DISORDS, L_T_DISORDS_UTDN, LC_T_UTDN_MUBAR,                 & ! Linearized
...
!
      ...
      SUBROUTINE VLIDORT_LCS_CONVERGE ( &
        ...
        N_USER_STREAMS, LOCAL_UM_START, N_OUT_STREAMS,                        & ! Input control numbers
...
!  Single scattering and DB inputs
      ...
      DOUBLE PRECISION, INTENT (IN) :: COLUMNWF_SS   ( MAX_ATMOSWFS, MAX_USER_LEVELS, &
                                                       MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS )
      DOUBLE PRECISION, INTENT (IN) :: COLUMNWF_DB   ( MAX_ATMOSWFS, &
...
!  Output fields
      ...
      DOUBLE PRECISION, INTENT (INOUT) :: SURFACEWF ( MAX_SURFACEWFS, MAX_USER_LEVELS, &
                                                      MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS )
      DOUBLE PRECISION, INTENT (INOUT) :: COLUMNWF ( MAX_ATMOSWFS, MAX_USER_LEVELS, &
                                                      MAX_GEOMETRIES, MAXSTOKES, MAX_DIRECTIONS )
                ...
                DO UT = 1, N_USER_LEVELS
                  DO I = 1, N_OUT_STREAMS
                    DO UA = 1, LOCAL_N_USERAZM
                      ...
                      DO O1 = 1, NSTOKES
                        COLUMNWF(Q,UT,V,O1,W) = COLUMNWF_F(Q,UT,I,IBEAM,O1,W)
                      ENDDO
                    ENDDO
                  ENDDO
                ENDDO
                  ...
                  DO I = LOCAL_UM_START, N_OUT_STREAMS
                    DO UA = 1, LOCAL_N_USERAZM
                      ...
                      DO O1 = 1, NSTOKES
                        ...
                        COLUMNWF(Q,UT,V,O1,W) = COLUMNWF(Q,UT,V,O1,W) + COLUMNWF_SS(Q,UT,V,O1,W)
                      ENDDO
                    ENDDO
                  ENDDO
                ENDDO
                ...
                DO I = LOCAL_UM_START, N_OUT_STREAMS
                  DO UA = 1, LOCAL_N_USERAZM
                    ...
                    DO O1 = 1, NSTOKES
                      ...
                      COLUMNWF(Q,UT,V,O1,UPIDX) = COLUMNWF(Q,UT,V,O1,UPIDX) + COLUMNWF_DB(Q,UT,V,O1)
                    ENDDO
                  ENDDO
                ENDDO
              ENDDO
                ...
                DO I = LOCAL_UM_START, N_OUT_STREAMS
                  DO UA = 1, LOCAL_N_USERAZM
                    ...
                    DO O1 = 1, NSTOKES
                      ...
                      SURFACEWF(Z,UT,V,O1,UPIDX) = SURFACEWF(Z,UT,V,O1,UPIDX) + SURFACEWF_DB(Z,UT,V,O1)
                    ENDDO
                  ENDDO
                ENDDO
              ENDDO
          ...
          IF ( .not. DO_FOCORR_ALONE ) THEN
            DO Q = 1, N_TOTALCOLUMN_WFS
              DO IDIR = 1, N_DIRECTIONS
                ...
                DO UT = 1, N_USER_LEVELS
                  DO O1 = 1, NSTOKES
                    COLUMNWF(Q,UT,IB,O1,W) = COLUMNWF_F(Q,UT,LUM,IB,O1,W)
                  ENDDO
                ENDDO
              ENDDO
            ENDDO
              ...
              DO IDIR = 1, N_DIRECTIONS
                ...
                DO UT = 1, N_USER_LEVELS
                  DO O1 = 1, NSTOKES
                    ...
                    COLUMNWF(Q,UT,IB,O1,W) = COLUMNWF(Q,UT,IB,O1,W) + COLUMNWF_SS(Q,UT,IB,O1,W)
                  ENDDO
                ENDDO
              ENDDO
            ENDDO
            ...
            DO Q = 1, N_TOTALCOLUMN_WFS
              DO UT = 1, N_USER_LEVELS
                DO O1 = 1, NSTOKES
                  ...
                  COLUMNWF(Q,UT,IB,O1,UPIDX) = COLUMNWF(Q,UT,IB,O1,UPIDX) + COLUMNWF_DB(Q,UT,IB,O1)
                ENDDO
              ENDDO
            ENDDO
          ENDIF
            ...
            DO Z = 1, N_SURFACE_WFS + N_SLEAVE_WFS
              DO UT = 1, N_USER_LEVELS
                DO O1 = 1, NSTOKES
                  ...
                  SURFACEWF(Z,UT,IB,O1,UPIDX) = SURFACEWF(Z,UT,IB,O1,UPIDX) + SURFACEWF_DB(Z,UT,IB,O1)
                ENDDO
              ENDDO
            ENDDO
          ENDIF
            ...
            DO IDIR = 1, N_DIRECTIONS
              ...
              DO UT = 1, N_USER_LEVELS
                DO O1 = 1, NSTOKES
                  ...
                  COLUMNWF(Q,UT,IB,O1,W) = COLUMNWF(Q,UT,IB,O1,W) + &
                       COLUMNWF_F(Q,UT,LUM,IB,O1,W)*AZMFAC(LUM,IB,LUA,O1)
                ENDDO
              ENDDO
            ENDDO
          ENDDO
...
!  Finish
      ...
      END MODULE vlidort_lc_wfatmos_m
