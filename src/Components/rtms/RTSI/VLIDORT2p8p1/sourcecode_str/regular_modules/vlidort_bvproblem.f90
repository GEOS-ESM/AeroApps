...
! ###############################################################
      ...
      USE VLIDORT_PARS_m, Only : MAXMOMENTS, MAXSTOKES, MAXSTREAMS, MAXLAYERS, MAXSTREAMS_2,      &
                                 MAXSTRMSTKS_2, MAXEVALUES, MAXSTOKES_SQ, MAXBANDTOTAL, MAXTOTAL, &
...
!     * Replaced GOTO construction with IF block
      ...
      USE VLIDORT_PARS_m, only : MAXMOMENTS, MAXSTOKES, MAXSTREAMS, MAXLAYERS, MAXSTREAMS_2,   &
                                 MAXSTRMSTKS_2, MAXBANDTOTAL, MAXTOTAL, MAXEVALUES, MAXSTOKES_SQ, zero
...
!    Enhancement # 4, S. Quesada 7/15/15. installed here 2/8/16
        DO I = 1, NSTREAMS
          DO O1 = 1, NSTOKES
            DO J = 1, NSTREAMS
              AXBID_F(I, J, MUELLER_INDEX(O1,1:NSTOKES)) = QUAD_STRMWTS(J) * BRDF_F(M, MUELLER_INDEX(O1,1:NSTOKES), I, J)
            ENDDO
          ENDDO
        ENDDO
...
!      --- Some rearrangement of subroutine arguments        
      ...
      USE VLIDORT_PARS_m, only : MAXSTREAMS, MAXSTOKES, MAXBEAMS, MAXLAYERS, MAXMOMENTS, MAX_SZANGLES, &
...
!  Special Fourier = 0 component calculation for the adjusted atmospheric downwelling Flux at BOA
      ...
      USE VLIDORT_PARS_m, Only : MAXSTOKES, MAXMOMENTS, MAXLAYERS, MAXSTREAMS, MAXBEAMS, MAX_SZANGLES,         &
                                 MAXBANDTOTAL, MAXTOTAL, MAXEVALUES, MAXSTREAMS_2, MAXSTRMSTKS, MAXSTRMSTKS_2, &
...
!     Zero the remaining polarized entries
         ...
         ELSE
            DO I = 1, NSTREAMS
               SL_QUADTERM(I,IBEAM,O1) = SLTERM_F_0(FOURIER,O1,I,IBEAM) * TFACTOR
            ENDDO
         ENDIF
...
!     * Replaced GOTO construction with IF block
      ...
      USE VLIDORT_PARS_m, only : MAXMOMENTS, MAXSTREAMS, MAXSTREAMS_2, MAXSTOKES, &
...
!  help variable
        ...
        DO I = 1, NSTREAMS
          DO O1 = 1, NSTOKES
            DO J = 1, NSTREAMS
              AXBID_F(I, J, MUELLER_INDEX(O1,1:NSTOKES)) = CUMQUAD(J) * BRDF_F(M, MUELLER_INDEX(O1,1:NSTOKES), I, J)
            ENDDO
          ENDDO
        ENDDO
