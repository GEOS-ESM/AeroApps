...
SUBROUTINE THERMAL_SETUP                                           &
      ( DO_UPWELLING, DO_DNWELLING, DO_THERMAL_TRANSONLY,          & !input
        ...
        DO_USER_STREAMS, LAYERMASK_UP, LAYERMASK_DN,               & !input
        ...
        BB_INPUT, T_DELT_USERM, T_UTDN_USERM, T_UTUP_USERM,        & !input
...
! ---------------
      ...
      INTEGER   :: AA, AA1, I, I1, S, N, UT, NT, NSTREAMS_2, M
...
! -----------------------------------------------------
        ...
        DO i = 1, nstreams
          ...
          t_wlower(i1,n) = s_m_l
          t_wlower(i,n)  = s_p_l
!        if (i.eq.3)write(54,*)n,t_wupper(i,n),t_wlower(i,n)
        END DO
...
!           write(24,*)um,layer_tsup_utup(um,1)
...
!           write(24,*)um,layer_tsup_dn(um,m)
!           write(24,*)um,t_ut_direct_dn(um,1)
!           write(24,*)um,layer_tsup_utdn(um,1)
