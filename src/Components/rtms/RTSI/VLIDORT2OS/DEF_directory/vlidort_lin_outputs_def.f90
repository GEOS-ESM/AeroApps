...
!  2OS correction Jacobians, for ICORR and R2
!    "Rob Change 10/20/14. Version 2.7E, 2OSCorr implementation"

      REAL(fpk), DIMENSION ( MAX_ATMOSWFS, MAX_GEOMETRIES )            :: TS_2OSCORR_LC_ICORR
      REAL(fpk), DIMENSION ( MAX_ATMOSWFS, MAX_GEOMETRIES, MAXSTOKES ) :: TS_2OSCORR_LC_R2
...
!    "Rob Change 10/20/14. Version 2.7E, 2OSCorr implementation"
      ...
      REAL(fpk), DIMENSION ( MAX_ATMOSWFS, MAXLAYERS, MAX_GEOMETRIES )            :: TS_2OSCORR_LP_ICORR
      REAL(fpk), DIMENSION ( MAX_ATMOSWFS, MAXLAYERS, MAX_GEOMETRIES, MAXSTOKES ) :: TS_2OSCORR_LP_R2
...
!  2OS correction Jacobians, for ICORR and R2. Surface Jacobians.
!    "Rob Change 10/20/14. Version 2.7E, 2OSCorr implementation"

      REAL(fpk), DIMENSION ( MAX_SURFACEWFS, MAX_GEOMETRIES )            :: TS_2OSCORR_LS_ICORR
      REAL(fpk), DIMENSION ( MAX_SURFACEWFS, MAX_GEOMETRIES, MAXSTOKES ) :: TS_2OSCORR_LS_R2
...
!  truncation factor and optical properties (scaled)
      ...
      REAL(fpk), dimension ( MAX_ATMOSWFS, MAXLAYERS ) :: TS_L_TRUNC_FACTOR

!  Scaled SSAs and phase function moments

      REAL(fpk), dimension ( MAX_ATMOSWFS, MAXLAYERS ) :: TS_L_DELTAU_VERT
      REAL(fpk), dimension ( MAX_ATMOSWFS, MAXLAYERS ) :: TS_L_OMEGA_TOTAL

      REAL(fpk) :: TS_L_GREEKMAT_TOTAL &
            ( MAX_ATMOSWFS, 0:MAXMOMENTS, MAXLAYERS, MAXSTOKES_SQ )

      END TYPE VLIDORT_LinDiag
