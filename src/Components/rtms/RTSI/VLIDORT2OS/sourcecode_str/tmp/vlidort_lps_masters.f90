...
!    "Rob Change 10/20/14. Version 2.7E, 2OSCorr implementation"
      ...
      IF ( STATUS_SUB .EQ. VLIDORT_SERIOUS ) THEN
        ...
        VLIDORT_Out%Status%TS_ACTIONS(NCHECKMESSAGES) = ' Serious error from VLIDORT_DERIVE_INPUT, called in VLIDORT_LPS_MASTERS'
        RETURN
      ENDIF
...
!    of "NSTOKES" and "NSTOKES_SQ" in MISCSETUPS and LAP_MISCSETUPS calls
!    "Rob Change 10/20/14. Version 2.7E, 2OSCorr implementation"
...
!       SSCORR_NADIR,    LP_SSCORR_NADIR,,
!       SSCORR_OUTGOING, LP_SSCORR_OUTGOING, 
!       DBCORRECTION,    LAP_DBCORRECTION, LS_DBCORRECTION, LSSL_DBCORRECTION 
!  Also: VFO_LPS Master + local copy of FO results to SS output
!       "Rob Change 10/20/14. Version 2.7E, 2OSCorr implementation"
...
!  New first-order code added 02 Jul 2013
          ...
          IF ( DO_FO_CALC ) THEN
            ...
            PROFILEWF_SS(1:N_TOTALPROFILE_WFS,1:NLAYERS,&
                         1:N_USER_LEVELS,1:NBEAMS,1:LOCAL_NSTOKES,:) = &
