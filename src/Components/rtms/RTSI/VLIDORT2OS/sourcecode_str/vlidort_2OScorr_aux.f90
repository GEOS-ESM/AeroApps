...
! #      vlidort_2OScorr_write_status:                          #
! #                             M. Christi - modified from      #  
! #                             R.J.D. Spurr, RTS, 2005, 2010   #
...
!  Convert a string to lower-case.  (ASCII character set assumed.)
      ...
      MODULE vlidort_2OS_corr_aux

      PRIVATE
      PUBLIC :: VLIDORT_2OSCORR_WRITE_STATUS
...
!  status check
      ...
      SUBROUTINE VLIDORT_2OSCORR_WRITE_STATUS &
...
!  Copy inputs to local variables
      ...
      STATUS_INPUTCHECK  = VLIDORT_Status%TS_2OSCORR_STATUS_INPUTCHECK

      NCHECKMESSAGES = &
        VLIDORT_Status%TS_2OSCORR_NCHECKMESSAGES
      CKMESSAGES(0:NCHECKMESSAGES) = &
        VLIDORT_Status%TS_2OSCORR_CHECKMESSAGES(0:NCHECKMESSAGES)
      ACTIONS(0:NCHECKMESSAGES)    = &
        VLIDORT_Status%TS_2OSCORR_ACTIONS(0:NCHECKMESSAGES)

!mick fix 2/4/2013 - added IF condition
      IF (STATUS_INPUTCHECK .NE. VLIDORT_SERIOUS) THEN
        STATUS_CALCULATION = VLIDORT_Status%TS_2OSCORR_STATUS_CALCULATION

        MESSAGE            = VLIDORT_Status%TS_2OSCORR_MESSAGE
        TRACE_1            = VLIDORT_Status%TS_2OSCORR_TRACE_1
        !TRACE_2            = VLIDORT_Status%TS_2OSCORR_TRACE_2
        !TRACE_3            = VLIDORT_Status%TS_2OSCORR_TRACE_3
      ENDIF
...
!  Finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_2OSCORR_WRITE_STATUS
...
!  finish
      ...
      END MODULE vlidort_2OS_corr_aux
