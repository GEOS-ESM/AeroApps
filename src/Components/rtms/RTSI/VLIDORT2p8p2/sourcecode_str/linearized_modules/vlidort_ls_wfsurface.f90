...
!  Top-level routine for the Surface-property weighting functions
...
!  Compute the linearized BOA source for the surface-property WFs
...
!  Surface reflection
!    BRDF incident quadrature streams, reflected user streams
!  4/15/20. Version 2.8.2. BRDF arrays defined locally, each Fourier, remove MAXMOMENTS dimension
            ...
            DO Q = 1, N_SURFACE_WFS
              DO O1 = 1, NSTOKES
                ...
                DO J = 1, NSTREAMS
                  ...
                  DO O2 = 1, NSTOKES
                    OM = MUELLER_INDEX(O1,O2)
                    S_REFLEC = S_REFLEC + INTEGRAND(Q,J,O2) * USER_BRDF_F(OM,IB,J)
                  ENDDO
                  REFLEC = REFLEC + S_REFLEC
                ENDDO
            ...
            DO Q = 1, N_SURFACE_WFS
              DO O1 = 1, NSTOKES
                REFLEC = ZERO
                  ...
                  DO O2 = 1, NSTOKES
                    OM = MUELLER_INDEX(O1,O2)
                    S_REFLEC = S_REFLEC + STOKES_DOWNSURF(J,O2) * LS_USER_BRDF_F(Q,OM,IB,J)
                  ENDDO
                  REFLEC = REFLEC + S_REFLEC
                ENDDO
                REFLEC = REFLEC * SURFACE_FACTOR
            ...
            ELSE
              DO Q = 1, N_SURFACE_WFS
                DO O1 = 1, NSTOKES
                  ...
                  DO O2 = 1, NSTOKES
                    OM = MUELLER_INDEX(O1,O2)
                    REFLEC = REFLEC + LS_USER_BRDF_F_0(Q,OM,LUM,IB) * FLUXVEC(O2)
                  ENDDO
                  REFLEC = REFLEC * REFL_ATTN
                  LS_BOA_SOURCE(Q,IB,O1) = LS_BOA_SOURCE(Q,IB,O1) + REFLEC
                ENDDO
