...
!  4/15/20. Version 2.8.2. BRDF array defined locally, remove Fourier index and MAXMOMENTS dimension
...
!  Surface inputs
!  4/15/20. Version 2.8.2. BRDF array defined locally, remove MAXMOMENTS dimension
