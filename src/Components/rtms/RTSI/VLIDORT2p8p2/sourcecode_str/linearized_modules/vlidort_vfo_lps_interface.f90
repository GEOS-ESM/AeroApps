...
!      -- Add DO_DOUBLET_GEOMETRY flag and Offset array (ND_OFFSET)
      ...
      USE VFO_RTCalc_LinMasters_m, Only : VFO_RTCALC_LPS_MASTER
      ...
      SUBROUTINE VFO_LPS_MASTER_INTERFACE ( &
        ...
        DO_PROFILEWFS, DO_SURFACEWFS, DO_SLEAVEWFS,                                      & ! Input Jacobian flags
        ...
        PARTLAYERS_OUTFLAG, PARTLAYERS_OUTINDEX, PARTLAYERS_LAYERIDX, LVARYFLAGS,        & ! Input partial/Geometry
         LVARYNUMS, LVARYFMAT, N_SLEAVEWFS, N_REFLECWFS, N_SURFACEWFS, FOGeometry,       & ! Input Jacobians/Geometry
        ...
        CUMTRANS, SLTERM, LP_CUMTRANS, LSSL_SLTERM )                                       ! Output - Auxiliary

!  4/15/20. Version 2.8.2. Drop MAXMOMENTS, MAXMOMENTS_INPUT, MAXFINELAYERS
!mick fix 3/2/2020 - changed order of inputs "n_sleavewfs" & "n_reflecwfs" back to original order
