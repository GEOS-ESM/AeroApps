      ...
      IF ( .NOT. DO_VARY .OR. .NOT. DO_FIRST ) THEN
        IF (.not. DO_OBSERVATION_GEOMETRY ) THEN
          IF ( DO_UPWELLING ) THEN
            L_UPAR_UP_1 (LOCAL_UM_START:N_USER_STREAMS, 1:NSTOKES, N, 1:N_PARAMETERS) = ZERO
            LC_UPAR_UP_2(LOCAL_UM_START:N_USER_STREAMS, 1:NSTOKES, N, 1:N_PARAMETERS) = ZERO
          ENDIF
          IF ( DO_DNWELLING ) THEN
            L_UPAR_DN_1 (LOCAL_UM_START:N_USER_STREAMS, 1:NSTOKES, N, 1:N_PARAMETERS) = ZERO
            LC_UPAR_DN_2(LOCAL_UM_START:N_USER_STREAMS, 1:NSTOKES, N, 1:N_PARAMETERS) = ZERO
          ENDIF
        ELSE
          IF ( DO_UPWELLING ) THEN
