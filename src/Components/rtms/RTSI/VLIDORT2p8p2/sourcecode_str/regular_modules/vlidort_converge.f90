...
!   -- Replaced STOKES_SS/DB (SS inputs), and STOKES (final output) with Type-structure variables
!   -- Rearranged argument list, removed DO_FOCORR_EXTERNAL. Now imilar to LIDORT 3.8.2

!  module, dimensions and numbers (modified to look like LIDORT 3.8.2, 4/15/20)
...
!  4/15/20. Version 2.8.2, removed this flag
...
!  Bookkeeping: Offsets for geometry indexing
      ...
      INTEGER, INTENT (IN) ::           LOCAL_UM_START, N_OUT_STREAMS
...
!
      ...
      SUBROUTINE VLIDORT_CONVERGE_OBSGEO &
       ( DO_FOCORR, DO_FOCORR_ALONE, DO_DBCORRECTION, DO_UPWELLING, DO_NO_AZIMUTH, & ! Input flags
         ...
         STOKES_F, MS_CONTRIBS_F, VLIDORT_SS, VLIDORT_Out,                         & ! Input/Output fields
...
!  This subroutine, new 4/15/20. Doublet output
!    * Use SZA_DOUBLET_OFFSET, Tie azimuth output to user-vza indexing (LUA = 1)
!    * Drop the Contribution stuff, drop LOCAL_UM_START
...
!  Local variables
      ...
      INTEGER ::          LUA = 1
      INTEGER ::          COUNT, V, N, I, IDIR, UT, W, O
      DOUBLE PRECISION :: TNEW ( MAXSTOKES ), ACCUR, TOLD ( MAXSTOKES ), TAZM ( MAXSTOKES )
...
!  4/15/20. Skip TOA Contribs here
