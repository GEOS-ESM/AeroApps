...
!      ---- MAX_MOMENTS_INPUT dimension replaced by MAXMOMENTS
...
!  Surface reflectance
!    4/15/20. Version 2.8.2. BRDF arrays are defined locally, each Fourier. Remove MAXMOMENTS dimension
...
!    4/15/20. Version 2.8.2. BRDF arrays are defined locally. Remove remove M=Fourier index
          ...
          ELSE
            DO O1 = 1, NSTOKES
              ...
              DO J = 1, NSTREAMS
                ...
                DO O2 = 1, NSTOKES
                  OM = MUELLER_INDEX(O1,O2)
                  S_REFLEC = S_REFLEC + STOKES_DOWNSURF(J,O2) * USER_BRDF_F(OM,IB,J)
                ENDDO
                REFLEC = REFLEC + S_REFLEC
!               IF ( DO_QTHTONLY ) BOA_THTONLY_SOURCE(1:NSTREAMS,O1) = REFLEC
             ENDDO
