...
!   5/22/20. Version 2.8.2 Upgrade. MUST BE AN EVEN NUMBER

      INTEGER, PARAMETER :: MAXSTREAMS_BRDF = 100
...
!  numbers
!  =======
!     4/15/20, Version 2.8.2. Retired cutoff BIGEXP and added new cutoff EXPCUTOFF
...
!  Rob fix 5/6/13 - Taylor series limiting values
      ...
      REAL(fpk), PARAMETER :: TAYLOR_SMALL = 1.0D-04
      REAL(fpk), PARAMETER :: TAYLOR_LARGE = 1.0d+04
...
!  Control for limits of single scatter albedo
      ...
      REAL(fpk), PARAMETER :: OMEGA_SMALLNUM = 1.0D-15
...
!     4/15/20, Version 2.8.2. Use new cutoff EXPCUTOFF

      REAL(fpk), PARAMETER :: MAX_TAU_SPATH = EXPCUTOFF
      REAL(fpk), PARAMETER :: MAX_TAU_UPATH = EXPCUTOFF
      REAL(fpk), PARAMETER :: MAX_TAU_QPATH = EXPCUTOFF
...
!  Maximum index. Revised to take into account two new kernls for 2.8.
