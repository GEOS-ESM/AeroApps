...
!  Parameter file. 4/15/20. MAXLAYERS Added for Version 2.8.2

      USE VLIDORT_PARS_m, Only : fpk, MAX_USER_LEVELS, MAX_GEOMETRIES, MAXLAYERS, MAXSTOKES, MAX_DIRECTIONS
...
!  SS Contribs. 4/15/20. Added for Version 2.8.2
