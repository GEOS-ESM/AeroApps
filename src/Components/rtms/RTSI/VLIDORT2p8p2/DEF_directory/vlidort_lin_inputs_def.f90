...
!      VLIDORT_Modified_LinInputs    Intent(InOut)
      ...
      USE VLIDORT_PARS_m, Only : fpk, MAX_ATMOSWFS, MAX_GEOMETRIES, MAXMOMENTS, MAXLAYERS, MAXSTOKES_SQ
...
!      REAL(fpk), dimension(MAX_ATMOSWFS, 0:MAXMOMENTS_INPUT, MAXLAYERS, MAXSTOKES_SQ) :: TS_L_GREEKMAT_TOTAL_INPUT
      REAL(fpk), dimension(MAX_ATMOSWFS, 0:MAXMOMENTS, MAXLAYERS, MAXSTOKES_SQ) :: TS_L_GREEKMAT_TOTAL_INPUT
