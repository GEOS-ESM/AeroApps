...
!                         Intent(Out) for VLIDORT BRDFSup
      ...
      USE VLIDORT_PARS_m, Only : fpk, MAXMOMENTS, MAXSTOKES, MAXSTREAMS, MAXBEAMS, &
                                 MAXSTOKES_SQ, MAX_USER_STREAMS, MAX_USER_RELAZMS
...
!  Exact (direct bounce) BRDF (same all threads)
      ...
      REAL(fpk), dimension ( MAXSTOKES_SQ, MAX_USER_STREAMS, MAX_USER_RELAZMS, MAXBEAMS ) :: TS_EXACTDB_BRDFUNC
...
!    incident quadrature streams, reflected user streams
      ...
      REAL(fpk), dimension ( 0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXBEAMS )   :: TS_BRDF_F_0
      REAL(fpk), dimension ( 0:MAXMOMENTS, MAXSTOKES_SQ, MAXSTREAMS, MAXSTREAMS ) :: TS_BRDF_F
      REAL(fpk), dimension ( 0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXBEAMS )   :: TS_USER_BRDF_F_0
      REAL(fpk), dimension ( 0:MAXMOMENTS, MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS ) :: TS_USER_BRDF_F
...
!  EVERYTHING PUBLIC HERE
      ...
      END MODULE VLIDORT_Sup_BRDF_def_m
