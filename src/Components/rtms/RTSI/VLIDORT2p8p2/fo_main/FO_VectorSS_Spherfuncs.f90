...
!  4/15/20. Version 1.5.2. Include option for Doublet-geometry.
...
SUBROUTINE FO_VectorSS_spherfuncs &
        ( MAXMOMENTS, MAXGEOMS, MAXSZAS, MAXVZAS, MAXAZMS, DTR,               & ! Inputs
          NMOMENTS, NGEOMS, NSZAS, NVZAS, NAZMS, NSTOKES,                 & ! Inputs
          STARTER, DO_OBSGEOM, DO_DOUBLET, DO_SPHERFUNC, DO_SUNLIGHT,     & ! Inputs
          NA_OFFSETS, ND_OFFSETS, THETA, ALPHA, PHI, COSSCAT, VSIGN,   & ! Inputs
          ROTATIONS, GSHELP, GENSPHER )                                     ! Outputs

!  4/15/20. Version 1.5.2. Include option for Doublet-geometry (Add flag and offsets)
!  4/15/20. Version 1.5.2. Rearranged the argument list
...
!  numbers and offsets (4/15/20. Version 1.5.2. Add ND_OFFSETS)
...
!  Geometry control (4/15/20. Version 1.5.2. DO_DOUBLET)
...
!  4/15/20. Version 1.5.2. This section is competely new for Doublet geometry option
...
!  4/15/20. Version 1.5.2. Add do_doublet to if-condition for lattce.
