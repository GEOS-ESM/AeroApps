...
!  5/22/20. VLIDORT Version 2.8.2 Upgrades. Add hfine/hfine_p inputs for correct DT calculation (Outgoing)
...
subroutine FO_DTWPGeometry_Master  &
       ( maxgeoms, maxlayers, maxpartials, maxfine, dtr, eradius,  & ! Input dimensions/constants
         ...
         nfinedivs,   xfine,   wfine,   radiifine,                 & ! Output Wholelayer
         alphafine,   sinfine,   cosfine,                          & ! Output Wholelayer
         nfinedivs_p, xfine_p, wfine_p, radiifine_p,               & ! Output partial up
         alphafine_p, sinfine_p, cosfine_p,                        & ! Output partial up
