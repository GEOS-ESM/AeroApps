...
!  4/15/20. Version 2.8.2. Add DOUBLET_GEOMETRY option, throughout code
...
!  4/15/20. Version 2.8.2. Add doublet geometry option
      ...
      DO_DOUBLET_GEOMETRY = .FALSE.  !@@ New line 4/15/20. Version 2.8.2
...
!  Observational and Doublet Geometry
!  ==================================
...
!  4/15/20. Version 2.8.2. Safety check on geometry options

      IF ( DO_USER_OBSGEOMS .and. DO_DOUBLET_GEOMETRY) THEN
         NM = NM + 1
         MESSAGES(NM) = 'No allowed to have both Observation and Doublet Gometry options'
...
!  4/15/20. Version 2.8.2. doublet geometry option, set number of azimuths = number of user streams
...
!  4/15/20. Version 2.8.2, Now done after the zenith angles, because might need Doublet correlation
...
!  4/15/20. Version 2.8.2. Check that the number of angles equals the number of streams, doublet geometry

      IF ( DO_DOUBLET_GEOMETRY .and. (N_USER_RELAZMS .ne. N_USER_STREAMS) ) THEN
        NM = NM + 1
        MESSAGES(NM) = 'Doublet geometry: Number of relative azimuth angles /= number of zenith angles'
        ACTIONS(NM)  = 'Re-set input value N_USER_RELAZMS same as  _USER_STREAMS'
        STATUS       = VLIDORT_SERIOUS
        NMESSAGES    = NM
        GO TO 764
      ENDIF
...
!  4/15/20. Version 2.8.2. Add doublet geometry flag to all subroutine calls
...
!  4/15/20. Version 2.8.2. Add DO_DOUBLET_GEOMETRY flag to argument lists
