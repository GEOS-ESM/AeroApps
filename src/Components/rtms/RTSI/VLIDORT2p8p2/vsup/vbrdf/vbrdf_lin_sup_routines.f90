...
!  include file of dimensions and numbers
      ...
      USE VLIDORT_PARS_m, Only : MAXSTREAMS_BRDF, MAXSTREAMS_SCALING, MAX_BRDF_PARAMETERS, ZERO, ONE, HALF
...
!  include file of dimensions and numbers
      ...
      USE VLIDORT_PARS_m, Only : MAXSTOKES_SQ, MAX_USER_STREAMS, MAXSTREAMS, MAXBEAMS, MAXSTOKES, &
                                 MAXSTREAMS_BRDF, MAXSTHALF_BRDF, MAX_BRDF_PARAMETERS, ZERO, HALF, ONE
