"""
   Implements Python interface for a TOMS-like set of channels, based
   on the OMI aerosol product OMAERUV.
"""
...
CHANNELS = [312., 317., 322., 325., 331., 340., 354., 360., 380., 388., 471.]
...
if __name__ == "__main__":
    ...
    toms_fn = '/nobackup/OMI/Level2/OMAERUV/2008/06/30/OMI-Aura_L2-OMAERUV_2008m0630t0233-o21055_v003-2009m0305t115716.he5'
    ...
    toms = TOMS_L2(toms_fn,Verbose=1)
    toms.sampleFile(g5_fn,onlyVars=onlyVars,npzFile=npz_fn,Verbose=1)

def hold():
    syn_time = datetime(2008,0o6,30,12,0,0)
    files = orbits("/nobackup/OMI/Level2","TOMS",syn_time,Verbose=0)
    q = TOMS_L2(files,Verbose=1)
