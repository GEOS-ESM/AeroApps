...
*...................................................................
      ...
      subroutine ODS_NCG_I2toR ( ncid,  varid,
     .                           start, count,
     .                           nval,  values, ierr )
...
!-------------------------------------------------------------------------
!
! !ROUTINE:  ODS_NCG_I2toR
! 
! !DESCRIPTION:
!     This routine calls the NetCDF routine, NCVGT, to read two
!     byte integer data from an ODS/HDF file and converts the 
!     data to native real numbers.  This routine insures that the
!     data are correctly returned from the NetCDF routine,
!     irrespective of the machine on which the software is running. 
!
! !INTERFACE:  ODS_NCG_I2toR ( ncid,  varid,
!                                     start, count,
!                                     nval,  values, ierr )
!
! !INPUT PARAMETERS: 
...
!
! !SEE ALSO:
!     ODS_NCP_RtoI2  ( The inverse companion of this routine )
!
! !REVISION HISTORY: !
