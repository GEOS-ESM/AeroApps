...
!BOP -------------------------------------------------------------------
!
! !MODULE: m_CorMatxU - blocked matrix attributes
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname='m_CorMatxU'
...
! !INTERFACE:
	...
	nav,krNav,ktNav, kx,ks,kl,collVec,xi,yi, stat	)
      ...
      integer,dimension(  :),intent(in) :: ks		! (  nvp)
...
!EOP ___________________________________________________________________
  ...
  call symCx_tr_(mNav,spGath,spScat,kind_C,comm,	&
	nav,krNav,ktNav,kx,ks,kl,collVec,transpose(xi),ty,stat=ier)
...
!________________________________________
	...
	call zeit_ci("sMatxU_agat")

	Call PartialGather(xi, xp, spGath)

	call zeit_co("sMatxU_agat")
...
!________________________________________
  ...
  yp(:,:)=0.
	...
	call zeit_ci("sMatxUxpy")

  call symCxpy(mNav,kind_C,			&
	nav,nvseg,krNav,ktNav,nvp,kx,ks,kl,	&
...
! !INTERFACE:
	...
	row_nav,row_krNav,row_ktNav,row_kx,row_ks,row_kl,	&
	col_nav,col_krNav,col_ktNav,col_kx,col_ks,col_kl,	&
	x_collVec,xi, y_collVec,yi, stat			)
      ...
      integer,dimension(  :),intent(in) :: row_ks	! (  nyp)
      ...
      integer,dimension(  :),intent(in) :: col_ks	! (  nxp)
...
! !INTERFACE:
	...
	x_collVec,xi, y_collVec,yi, stat			)
      ...
      type(Collector),intent(in) :: y_collVec
      real,dimension(:,:),intent(inout) :: yi		! (nvecs,nyi)
...
!________________________________________
  ...
  call recCxpy(mNav,kind_C,			&
	...
	call zeit_co("rMatxUxpy")

!________________________________________

	call zeit_ci("rMatxU_rscat")
