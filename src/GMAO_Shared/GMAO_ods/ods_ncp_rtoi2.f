...
*...................................................................
      ...
      subroutine ODS_NCP_RtoI2 ( ncid,  varid,
     .                           start, count,
     .                           nval,  values, ierr )
...
!-------------------------------------------------------------------------
!
! !ROUTINE:  ODS_NCP_RtoI2
! 
! !DESCRIPTION: 
!     This routine converts native real numbers to two byte integers
...
!
! !INTERFACE:  ODS_NCP_RtoI2 ( ncid,  varid,
!                                     start, count,
!                                     nval,  values, ierr )
!
! !INPUT PARAMETERS: 
...
!
! !SEE ALSO:
!     ODS_NCG_I2toR  ( The inverse companion of this routine )
!
! !REVISION HISTORY: !
...
*     -----------------------------------------------------
      do 10, ival = 1, nval
         ...
         if ( val  .lt. I2_MinR .or.
     .        val  .gt. I2_MaxR ) ierr = NCSysErr
 10   continue
...
*     ----------------------------------------------
 ...
 901  format ( /, ' ODS_NCP_RtoI2: Value to be written as the ',
