...
*...................................................................
      ...
      subroutine ODS_ScaleR ( ncid, varid, nval, values, ierr )
...
! 
! !DESCRIPTION: 
!     This routine scales an array of real numbers according to the
!     expression
!
!          R_scaled = scale_factor * R + add_offset
!
!     where R and R_scaled are the unscaled and scaled real numbers,
!     respectively and scale_factor and offset are parameters
!     extracted as attributes from the NetCDF file.  The routine
!     correctly handles the cases when one or both of these
!     attributes do not exist in the NetCDF file.
!
...
!
! !SEE ALSO:
!     ODS_ScaleI     ( The parallel routine for integers     )  
!     ODS_ScaleRRev  ( The inverse companion of this routine )
!     ODS_ScaleIRev  ( The inverse companion of ODS_ScaleI   )
!
! !FILES USED:
...
*        -------------------------------------------
         do 30, ival = 1, nval
            values ( ival )
     .         = values ( ival ) * scale_factor + add_offset
 30      continue
...
*     ------
 ...
 901  format ( /, ' ODS_ScaleR: Error in extracting an attribute. ',
     .         /, '             Attribute name is ', a )
