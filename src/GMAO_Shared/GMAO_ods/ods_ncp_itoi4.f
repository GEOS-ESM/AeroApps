...
*...................................................................
      ...
      subroutine ODS_NCP_ItoI4 ( ncid,  varid,
     .                           start, count,
     .                           nval,  values, ierr )
...
!-------------------------------------------------------------------------
!
! !ROUTINE:  ODS_NCP_ItoI4
! 
! !DESCRIPTION: 
!     This routine converts native integers to four byte integers
!     and calls the NetCDF routine, NCVPT, to write the four byte
!     integers to an ODS/HDF file.  This routine insures that the
!     data are correctly passed into the NetCDF routine,
!     irrespective of the machine on which the software is running. 
!
! !INTERFACE:  ODS_NCP_ItoI4 ( ncid,  varid,
!                                     start, count,
!                                     nval,  values, ierr )
!
! !INPUT PARAMETERS: 
...
!
! !SEE ALSO:
!     ODS_NCG_I4toI  ( The inverse companion of this routine )
!
! !REVISION HISTORY: !
...
*     Convert to four-byte integers and store into work space
*     -------------------------------------------------------
      do 20, ival = 1, nval
         I4_Val ( ival ) = values ( ival )
 20   continue
...
*     ------
 ...
 901  format ( /, ' ODS_NCP_ItoI4: Value to be written as the ',
