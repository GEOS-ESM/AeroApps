...
*...................................................................
      ...
      subroutine ODS_NCG_I1toR ( ncid,   varid,
     .                           start,  count,
     .                           nval,   values, ierr )
...
!-------------------------------------------------------------------------
!
! !ROUTINE:  ODS_NCG_I1toR
! 
! !DESCRIPTION:
!     This routine calls the NetCDF routine, NCVGTC, to read one
!     byte integer data from an ODS/HDF file and converts the 
!     data to native real numbers.  The ODS package treats each
!     byte as unsigned integers with values within the range
!     from 0 to 255, inclusively.  An offset value of 256 is
!     added to any negative value.  This routine insures that
!     the data are correctly returned from the NetCDF routine,
!     irrespective of the machine on which the software is
!     running. 
!
! !INTERFACE:  ODS_NCG_I1toR ( ncid,   varid,
!                                     start,  count,
!                                     nval,   values, ierr )
!
! !INPUT PARAMETERS: 
...
!
! !SEE ALSO:
!     ODS_NCP_RtoI1  ( The inverse companion of this routine )
!
! !REVISION HISTORY: !
!     29Mar1996   C. Redder   Origional code
