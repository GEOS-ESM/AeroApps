...
*...................................................................
      ...
      subroutine ODS_NCP_RtoR4 ( ncid,  varid,
     .                           start, count,
     .                           nval,  values, ierr )
...
!-------------------------------------------------------------------------
!
! !ROUTINE:  ODS_NCP_RtoR4
! 
! !DESCRIPTION: 
!     This routine converts native real numbers to four byte real
...
!     is running. 
!
! !INTERFACE:  ODS_NCP_RtoR4 ( ncid,  varid,
!                                     start, count,
!                                     nval,  values, ierr )
!
! !INPUT PARAMETERS: 
...
!
! !SEE ALSO:
!     ODS_NCG_R4toR  ( The inverse companion of this routine )
!
! !REVISION HISTORY: !
...
*     Convert to 4-byte integers and store in work space
*     --------------------------------------------------
      do 20, ival = 1, nval
         R4_Val ( ival ) = values ( ival )
 20   continue
...
*     ------
 ...
 901  format ( /, ' ODS_NCP_RtoR4: Value to be written as the ',
