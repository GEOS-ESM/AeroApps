...
*...................................................................
      ...
      subroutine ODS_NCP_RtoI1 ( ncid,   varid,
     .                           start,  count,
     .                           nval,   values, ierr )
...
!-------------------------------------------------------------------------
!
! !ROUTINE:  ODS_NCP_RtoI1
! 
! !DESCRIPTION: 
!     This routine converts native real numbers to one byte integers
!     and calls the NetCDF routine, NCVPTC, to write the one byte
!     integers to a ODS/HDF file.  The ODS package treats each byte
!     as unsigned integers with values within the range from 0 to
!     to 255, inclusively.  This routine insures that the data are
!     correctly passed into the NetCDF routine, irrespective of the
!     machine on which the software is running. 
!
! !INTERFACE:  ODS_NCP_RtoI1 ( ncid,   varid,
!                                     start,  count,
!                                     nval,   values, ierr )
!
! !INPUT PARAMETERS: 
...
!
! !SEE ALSO:
!     ODS_NCG_I1toR  ( The inverse companion of this routine )
!
! !REVISION HISTORY: !
...
*     -----------------------------------------------------
      do 10, ival = 1, nval
         ...
         if ( val  .lt. I1_MinR .or.
     .        val  .gt. I1_MaxR ) ierr = NCSysErr
 10   continue
...
*     ----------------------------------------------
 ...
 901  format ( /, ' ODS_NCP_RtoI1: Value to be written as the ',
