...
!BOP -------------------------------------------------------------------
!
! !MODULE: m_CorMatxF - blocked matrix attributes
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname='m_CorMatxF'
...
! !INTERFACE:
    ...
    subroutine symCx_(mNav,spGath,spScat, &
	 kind_C,comm,			  &
	nav,krNav,ktNav, qr,qd,kl,collVec,xi,yi, stat	)
      ...
      real   ,dimension(:,:),intent(in) :: qd		! (3,nvp)
...
!EOP ___________________________________________________________________
  ...
  call symCx_tr_(mNav,spGath,spScat,kind_C,comm,	&
	nav,krNav,ktNav,qr,qd,kl,collVec,transpose(xi),ty,stat=ier)
...
! !INTERFACE:
    ...
    subroutine symCx_tr_(mNav,spGath,spScat, &
	 kind_C,comm,	                     &
	 nav,krNav,ktNav, qr,qd,kl,	     &
	 collVec,xi,yi	,stat		     )
      ...
      implicit none
				! About the matrix
      type(AttrVect),intent(inout) :: mNav
      type(SparseComm), intent(in) :: spGath
      type(SparseComm), intent(in) :: spScat
      integer,       intent(in)    :: kind_C
      integer,       intent(in)    :: comm
...
!________________________________________
	...
	call zeit_ci("sMatxF_agat")

	Call PartialGather(xi, xp, spGath)

	call zeit_co("sMatxF_agat")
...
!________________________________________
  ...
  yp(:,:)=0.
	...
	call zeit_ci("sMatxFxpy")

  call symCxpy(mNav,kind_C,	&
	nav,nvseg,krNav,ktNav,nvp,qr,qd,kl,	&
...
! !INTERFACE:
    ...
    subroutine recCx_(mNav, spGath, spScat,     &
	kind_C,comm,				&
	row_nav,row_krNav,row_ktNav,row_qr,row_qd,row_kl,	&
	col_nav,col_krNav,col_ktNav,col_qr,col_qd,col_kl,	&
	x_collVec,xi, y_collVec,yi, stat			)
      ...
      real   ,dimension(:,:),intent(in) :: row_qd	! (3,nyp)
      ...
      real   ,dimension(:,:),intent(in) :: col_qd	! (3,nxp)
...
!EOP ___________________________________________________________________
  ...
  nySeg=lsize(row_nav)
	ASSERT( nySeg<=size(row_krNav) )
	ASSERT( nySeg<=size(row_ktNav) )
  ...
  call recCx_tr_(mNav,spGath,spScat,kind_C,comm,		&
	row_nav,row_krNav,row_ktNav,row_qr,row_qd,row_kl,	&
	col_nav,col_krNav,col_ktNav,col_qr,col_qd,col_kl,	&
...
! !INTERFACE:
    ...
    subroutine recCxpy_(mNav,spGath, spScat, kind_C,comm,	&
	row_nav,row_krNav,row_ktNav,row_qr,row_qd,row_kl,	&
	col_nav,col_krNav,col_ktNav,col_qr,col_qd,col_kl,	&
	x_collVec,xi, y_collVec,yi, stat			)
...
!EOP ___________________________________________________________________
  ...
  call recCx_tr_(mNav,spGath,spScat,comm,kind_C,		&
	row_nav,row_krNav,row_ktNav,row_qr,row_qd,row_kl,	&
	col_nav,col_krNav,col_ktNav,col_qr,col_qd,col_kl,	&
	x_collVec,transpose(xi), y_collVec,ty, stat=ier		)
...
! !INTERFACE:
    ...
    subroutine recCx_tr_(mNav,spGath,spScat, kind_C,comm,	&
	row_nav,row_krNav,row_ktNav,row_qr,row_qd,row_kl,	&
	col_nav,col_krNav,col_ktNav,col_qr,col_qd,col_kl,	&
	x_collVec,xi, y_collVec,yi, stat			)
...
!________________________________________
	...
	call zeit_ci("rMatxF_rscat")

	call PartialReduceScatter(yp, yi, spScat)

	call zeit_co("rMatxF_rscat")
